...
### [13] [Lattice initialisation and finite-size effects of non-equilibrium molecular dynamics simulations for heat transfer across graphene-copper interfaces](https://arxiv.org/abs/2607.16783)
...
### [14] [Response-function-optimized phase field modeling of solute trapping and solute drag in rapid alloy solidification](https://arxiv.org/abs/2607.17370)
...
### [16] [Atomically precise triple-step staircase on a vicinal silicon surface: Is it Si(5 5 7), Si(7 7 10) or Si(8 8 11)?](https://arxiv.org/abs/2607.16439)
...
### [17] [Valley polarization, Rashba interaction, and weak altermagnetism in inversion-asymmetric MnPS$_\text{3}|$WS$_\text{2}$ van der Waals heterostructures](https://arxiv.org/abs/2607.16454)
...
### [18] [Bond reconstruction and vacancy clustering in monolayer silicon carbide from first principles](https://arxiv.org/abs/2607.16483)
*Péter Udvarhelyi*
...
### [19] [Instability-Avoiding Active Learning for Cluster Expansions in Complex Multielement Materials](https://arxiv.org/abs/2607.16486)
...
### [20] [Phase nucleation and evolution pathways of a nanostructured Inconel 725 alloy during heat treatment](https://arxiv.org/abs/2607.16495)
...
### [21] [Signal amplification in simple metal-insulator transition devices](https://arxiv.org/abs/2607.16566)
...
### [25] [Beyond Janus Atomic Ordering: High-Throughput First-Principles Search for Hidden MoSO Monolayer Structures](https://arxiv.org/abs/2607.16589)
...
### [26] [High-entropy perovskites, architectured by s0/d0/d10 cations, as novel electrolytes for solid oxide fuel cells](https://arxiv.org/abs/2607.16616)
...
### [27] [Three Million Years Opposite State Data Retention in Partially Switched Wurtzite Ferroelectrics](https://arxiv.org/abs/2607.16665)
...
### [28] [Period-dependent suppression of Fourier peaks for topography images: Analysis of periodicity of triple-step arrays on vicinal Si(h h m) surfaces](https://arxiv.org/abs/2607.16699)
...
### [29] [Measuring momentum-resolved dissipation of phonon-polaritons in LiNbO$_3$ with terahertz driving](https://arxiv.org/abs/2607.16718)
...
### [30] [Electrical Control of Altermagnetism in a Quasi-1D Magnet](https://arxiv.org/abs/2607.16856)
...
### [31] [Specimen design for material parameter identification using topology optimization](https://arxiv.org/abs/2607.16865)
...
### [32] [Operando observation of strain relaxation in fatigued pearlitic steel](https://arxiv.org/abs/2607.16867)
...
### [33] [Planar Microcavities can Suppress Exciplex Formation and Increase the Emission Efficiency of Organic Semiconductors](https://arxiv.org/abs/2607.16886)
...
### [34] [The crystallographic quaternions and their product law](https://arxiv.org/abs/2607.16899)
*Cyril Cayron*
...
### [35] [Baldereschi mean value points for three-dimensional Bravais lattices](https://arxiv.org/abs/2607.16974)
*N. D. Drummond*
...
### [36] [Giant Flat Band Amplification via Inertial Anchors](https://arxiv.org/abs/2607.17011)
...
### [37] [STEP: Spin Tensor Equivariant Potential for Data-Efficient Learning of Magnetic Potential Energy Surfaces](https://arxiv.org/abs/2607.17129)
...
### [38] [XMatcher: An Open-Source Framework for X-Ray Diffraction Phase Identification](https://arxiv.org/abs/2607.17162)
*Bin Cao*
...
### [39] [First-principles electron-phonon scattering in real-time TDDFT](https://arxiv.org/abs/2607.17265)
...
### [40] [Interfacial thermal transport in Si/SiC and SiC/diamond heterostructures: effects of amorphous interlayers and SiC polytypes](https://arxiv.org/abs/2607.17330)
...
### [41] [Symmetry-Engineered Nonlinear Hall Response and Optical Response in Strained Monolayer Janus AsTeBr](https://arxiv.org/abs/2607.17385)
...
### [42] [Mechanical loss in amorphous solids: spatial correlations, interacting transitions, and annealed thermodynamic pathways](https://arxiv.org/abs/2607.17434)
...
### [43] [Going Beyond the d-band Center to Design Intermetallic Catalysts for Nitrogen Reduction: A High-Throughput DFT and Machine Learning Study](https://arxiv.org/abs/2607.17463)
...
### [44] [Non-equilibrium Effects in Vibrational Modes Pumped by Inelastic Tunneling](https://arxiv.org/abs/2607.17530)
...
### [45] [CuCrZr heat-sink irradiation performance reveals new challenges for thermonuclear fusion reactors](https://arxiv.org/abs/2607.17594)
...
### [46] [d-band filling dictates magnetic stability in Mn- and Co-substituted FeRh alloys](https://arxiv.org/abs/2607.17688)
...
### [47] [Efficient Quantum-Mechanical Modeling of Nonradiative Charge Transfer Processes](https://arxiv.org/abs/2607.17730)
...
### [48] [Physically motivated iso-orbital indicator for meta-GGA exchange functionals](https://arxiv.org/abs/2607.17736)
...
### [49] [Localized crystallization of Ce:YIG thin films on Si using CO2 laser annealing for integrated nonreciprocal photonic device applications](https://arxiv.org/abs/2607.17905)
...
### [50] [Chemical filters for ultra-high-throughput materials screening and generation](https://arxiv.org/abs/2607.17910)
...
### [51] [The Recurrent Structural Frameworks of Stable Inorganic Materials](https://arxiv.org/abs/2607.17911)
...
### [52] [Informatics Modeling of High Tg Polymers: Assessing the Role of Processing versus Chemistry](https://arxiv.org/abs/2607.17925)
...
### [53] [Spin-phonon interaction in a symmetry-enforced spin-polarized state](https://arxiv.org/abs/2607.17980)
...
### [54] [Foundry CMOS platform for multimodal quantum materials characterization](https://arxiv.org/abs/2607.18059)
...
### [55] [First-principles electronic transport properties of Ti and Ti-6Al-4V for modeling ultrashort-pulse laser ablation](https://arxiv.org/abs/2607.18085)
...
### [56] [Correcting DFT formation energies towards experimental accuracy using foundational MLIPs and latent-feature delta-learning](https://arxiv.org/abs/2607.18092)
...
### [57] [Optimal transition states for polaron hopping transport without supercells](https://arxiv.org/abs/2607.18096)
...
### [58] [Study of ordering in (MoCrTi)$_{100-x}$Al$_x$ refractory high-entropy alloys using machine learning interatomic potential](https://arxiv.org/abs/2607.18099)
...
### [59] [Defect configuration, not nitrogen content, governs the mechanical integrity of nitrogen-doped graphene: a molecular dynamics study](https://arxiv.org/abs/2607.18129)
...
### [60] [Phase-field modeling of TiO2 nanocarving via reaction with hydrogen-bearing gas](https://arxiv.org/abs/2607.18172)
...
### [63] [Modeling rare-earth and energy materials supply chains under theoretical China-outer-Mongolia political reunification scenarios](https://arxiv.org/abs/2607.18019)
*Xi Liu,Wenxi Fang*
...
### [64] [anyakrakusuma: A Python Library for Entropic Schrödinger Bridges on Idealized Geometries](https://arxiv.org/abs/2607.18184)
