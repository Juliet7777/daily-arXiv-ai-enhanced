...
### [2] [Observation of topological surface phonons in diamond with nonlinear optics](https://arxiv.org/abs/2609.12362)
...
### [3] [Assessing the magnetic states and the accuracy of first-principles Hubbard corrections for the battery cathode Li$_x$CoO$_2$ ($x=0,1$)](https://arxiv.org/abs/2609.12984)
...
### [4] [Remarks on invertible phases with non-onsite symmetry](https://arxiv.org/abs/2609.12042)
...
### [5] [Diversifying time evolution of matrix product states using BUGs](https://arxiv.org/abs/2609.12848)
...
### [6] [Spin splitting without symmetry: a nearly compensated ferrimagnet and the origin of altermagnetism](https://arxiv.org/abs/2609.12931)
*Joo Yull Rhee*
