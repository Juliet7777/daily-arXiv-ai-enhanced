...
### [4] [Differentiable hybrid force fields support scalable autonomous electrolyte discovery](https://arxiv.org/abs/2604.07979)
...
### [5] [Optomagnetic non-thermal modification of the ferromagnetic resonance](https://arxiv.org/abs/2604.07555)
...
### [6] [Strain continuously rotates the Néel vector in altermagnetic MnTe](https://arxiv.org/abs/2604.07653)
...
### [7] [Symmetry-guided and AI-accelerated design of intercalated transition metal dichalcogenides for antiferromagnetic spintronics](https://arxiv.org/abs/2604.07689)
...
### [8] [Alkaline-Earth Rare-Earth Fluoride Nanoparticle Superlattices for Ultrafast, Radiation Stable Scintillators](https://arxiv.org/abs/2604.07827)
...
### [9] [Tailoring the Optoelectronic, Photocatalytic, Thermoelectric and Thermodynamic Properties of Halides Li2InBiX6 (X = Cl, Br, I) for Energy Conversion: A DFT Study](https://arxiv.org/abs/2604.08022)
...
### [10] [Emergence of Lissajous trajectories in skyrmion oscillator](https://arxiv.org/abs/2604.08073)
...
### [11] [Oxophilic Silver-Based Nanoparticles with Low Pd-Au Loading for Ethanol and Glycerol Electrooxidation in Alkaline Media](https://arxiv.org/abs/2604.08081)
...
### [12] [Unveiling the Core of Materials Properties via SISSO and Sensitivity Analysis](https://arxiv.org/abs/2604.08122)
...
### [13] [Equivariant Many-body Message Passing Interatomic Potentials for Magnetic Materials](https://arxiv.org/abs/2604.08143)
...
### [14] [Switching magnetic spin-states using small magnetic fields in compositionally complex Sm(M7)O$_3$](https://arxiv.org/abs/2604.08163)
...
### [15] [Bulk versus interface nucleation of CO$_2$ hydrates from computer simulations](https://arxiv.org/abs/2604.08187)
...
### [16] [Giant photostriction in lead-free ferroelectric stemming from photo-excited thermalized carriers](https://arxiv.org/abs/2604.08218)
...
### [17] [Odd-parity Magnetism from the Generalized Bloch Theorem](https://arxiv.org/abs/2604.08233)
...
### [18] [Rapid and Highly Efficient Synergistic Sonophotocatalytic Degradation of Methyl Orange with CuDoped LaFeO3 Perovskite Nanoparticles](https://arxiv.org/abs/2604.08257)
...
### [19] [2D Ferroelectric Ruddlesden-Popper Perovskites: an Emerging Fully Electronically Controllable Shift Current and Persistent Spin Helix](https://arxiv.org/abs/2604.08360)
...
### [20] [Comparative high-pressure study on rare-earth entropy fluorite-type oxides](https://arxiv.org/abs/2604.08371)
...
### [21] [Theory-Guided Discovery of Pressure-Induced Transitions in Fast-Ion Conductor BaSnF4](https://arxiv.org/abs/2604.08376)
...
### [22] [CATAPULT: A CUDA-Accelerated Timestepper for Alpha Particles Using Local Tricubics](https://arxiv.org/abs/2604.07617)
...
### [23] [Reinforcement learning with reputation-based adaptive exploration promotes the evolution of cooperation](https://arxiv.org/abs/2604.08103)
...
### [24] [Direction-aware topological descriptors for Young's modulus prediction in porous materials](https://arxiv.org/abs/2604.08105)
...
### [25] [K$_2$Co$_2$(TeO$_{3}$)$_{3}$ $\cdot$ 2.5 H$_2$O : A mineral-inspired pseudo-honeycomb cobalt dimer antiferromagnet](https://arxiv.org/abs/2604.07376)
...
### [26] [d-Wave pair density wave superconductivity in a two-orbital model](https://arxiv.org/abs/2604.07511)
...
### [27] [Fortuitous Universality of Bose-Kondo Impurities](https://arxiv.org/abs/2604.07554)
...
### [28] [Directional Criticality and Higher-Order Flatness: Designing Van Hove Singularities in Three Dimensions](https://arxiv.org/abs/2604.07806)
...
### [29] [Fluctuation Mechanism of Single-Ion Anisotropy of Topological Insulator MnBi$_2$Te$_4$](https://arxiv.org/abs/2604.07852)
...
### [30] [Hubbard vs. Emery model: spectra, transport and relevance for cuprates](https://arxiv.org/abs/2604.08085)
...
### [31] [Co-operating multiorbital and nonlocal correlations in bilayer nickelate](https://arxiv.org/abs/2604.08221)
...
### [33] [Revealing the nature of the charge density wave order of ErTe$_3$ via Raman scattering under anisotropic strain](https://arxiv.org/abs/2604.08440)
