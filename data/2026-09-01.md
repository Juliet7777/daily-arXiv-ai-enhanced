...
### [19] [Charge-State Dependence of Electronic Excitations in keV Ions Transmitted Through Solids Probed by Ion-Photon Coincidence Measurements](https://arxiv.org/abs/2608.28717)
...
### [20] [Elastic properties of amorphous LiTaCl$_6$ solid-state electrolyte](https://arxiv.org/abs/2608.29404)
...
### [21] [Benchtop Momentum-Resolved Phonon Spectroscopy: Unlocking Lattice Dynamics via X-ray Diffuse Scattering](https://arxiv.org/abs/2608.28759)
...
### [22] [Dark exciton signatures in the infrared transient absorption of MoS$_2$ monolayer](https://arxiv.org/abs/2608.30504)
...
### [23] [Engineering Excitons through Polymorphism and Dimensional Confinement in Low-Dimensional Tellurium](https://arxiv.org/abs/2608.28861)
...
### [24] [Revealing low-energy surfaces of multinary compounds by controlling surface coordination environments](https://arxiv.org/abs/2608.28903)
...
### [25] [Energy landscape and dissipation of sliding magnetic rotor arrays](https://arxiv.org/abs/2608.28915)
...
### [26] [Giant staggered Dzyaloshinskii-Moriya vectors emerged in synthetic antiferromagnets with spatially alternating stress](https://arxiv.org/abs/2608.28953)
...
### [27] [Symmetry-Preserving Phase Transitions in $AM_2$Al$_9$ Materials under Pressure](https://arxiv.org/abs/2608.28957)
...
### [28] [Orbital occupation selects structural dimensionality in binary transition-metal oxides](https://arxiv.org/abs/2608.28996)
...
### [29] [Can a Spin Liquid State Persist as the Ground State in the Presence of Competing Interactions and Disorder?](https://arxiv.org/abs/2608.28998)
*Sumanta Mukherjee*
...
### [30] [Directional commensurability stabilizes structural superlubricity in patterned mesoscale interfaces](https://arxiv.org/abs/2608.29141)
...
### [31] [Single-pulse strain-induced precessional dynamics of magnetization in Co-doped iron garnet](https://arxiv.org/abs/2608.29245)
...
### [32] [Evaluating LLM-based AI agents integrated with materials synthesis tools: the case of atomic layer deposition](https://arxiv.org/abs/2608.29309)
*Angel Yanguas-Gil*
...
### [33] [Analogue Phase Change Computational Memory with High Precision Reads and Energy Efficient Writes](https://arxiv.org/abs/2608.29338)
...
### [34] [Strain-Driven Electronic and Catalytic Modulation of g-C3N4/GeS van der Waals heterostructure for Photocatalytic Water Splitting](https://arxiv.org/abs/2608.29340)
...
### [35] [PINN-Phase: A physics-informed neural network for curvature-driven multiphase-field evolution](https://arxiv.org/abs/2608.29413)
...
### [36] [Vibrational Origin of the Barocaloric Effect in the Spin-Crossover Complex Fe(pap-5NO2)2: A Combined DFT and Mean-Field Study](https://arxiv.org/abs/2608.29447)
...
### [37] [Solid and Quasi-Solid Electrolytes for Zinc Batteries: Balancing Water Activity, Ion Transport, and Interfaces](https://arxiv.org/abs/2608.29586)
...
### [38] [Evaluating a 4B open-weights local LLM for agentic DFT workflows: a literature reproducibility audit](https://arxiv.org/abs/2608.29665)
...
### [39] [High-Field Terahertz Spin Resonance in Cr$_2$O$_3$ above the Spin-Flop Transition](https://arxiv.org/abs/2608.29712)
...
### [40] [Floquet Topological Spin-Valley-Layertronics on a Layered Dice Lattice](https://arxiv.org/abs/2608.29833)
...
### [41] [Phonon-Localization-Driven Decoupling of Dual-Channel Transport for Record-Low Intrinsic Lattice Thermal Conductivity](https://arxiv.org/abs/2608.29778)
...
### [42] [Valley-Enabled Intrinsic Dresselhaus Spin-Orbit Coupling in Silicon](https://arxiv.org/abs/2608.29785)
...
### [43] [Cesium Clustering and Fluoroberyllate Network Disruption in FLiBe: A Total Scattering and Molecular Dynamics Study](https://arxiv.org/abs/2608.29898)
...
### [44] [Van Hove singularities at the $L$-face of the lutetium nitride phonon dispersion](https://arxiv.org/abs/2608.29994)
...
### [45] [Libron-phonon coupling and hydrogen-bond dynamics in the vacancy-ordered perovskite (NH4)2SnCl6: a temperature- and pressure-dependent Raman study](https://arxiv.org/abs/2608.30064)
...
### [46] [Two-step transient liquid phase bonding of NiTi to Ti-6Al-4V through a NbZrW barrier](https://arxiv.org/abs/2608.30117)
...
### [48] [Coexisting Large and Small Polarons in Photoexcited CeO$_2$](https://arxiv.org/abs/2608.30164)
...
### [49] [Covariant formula for the driving force for interface migration](https://arxiv.org/abs/2608.30296)
*Adam Morawiec*
...
### [50] [Real-space overlap is not enough: ambiguity in nanobeam iterative ptychography](https://arxiv.org/abs/2608.30359)
...
### [51] [Extending the Pnictide Chemical Space for Photovoltaics](https://arxiv.org/abs/2608.30402)
...
### [52] [Coupling of two individual magnon resonators via a superconducting microwave resonator operating in the strong coupling regime](https://arxiv.org/abs/2608.30454)
...
### [53] [Chemically Resolved Topological Coordinates Link Structural Dynamics and Configurational Thermodynamics](https://arxiv.org/abs/2608.30523)
...
### [54] [Heterogeneous ferroelectricity and conductivity of oxidized BaTiO$_3$ crystals: the role of nanoscale phase segregation in the surface region](https://arxiv.org/abs/2608.30552)
...
### [55] [Freezing of a deformable water-saturated porous medium. Part I: THM formulation, OpenGeoSys-6 implementation and benchmarking](https://arxiv.org/abs/2608.30591)
...
### [56] [Layer Axial Phonons and Dipolar Thermal Response in Centrosymmetric Thin Films](https://arxiv.org/abs/2608.30600)
...
### [57] [Topological and spin-orbit effects on orbital moments in ultra-thin magnetic films](https://arxiv.org/abs/2608.30642)
...
### [58] [Emergence and suppression of phonon vortices in two-dimensional crystals: Interplay of lattice symmetry, heavy impurities, and shear](https://arxiv.org/abs/2608.30645)
...
### [59] [Terahertz Control of Optical Second-Harmonic Generation in Displacive Ferroelectrics: Electronic Bloch-State Reconstruction](https://arxiv.org/abs/2608.30665)
...
### [60] [Halide donors in monoclinic- and corundum-phase Ga$_2$O$_3$ and Al$_2$O$_3$](https://arxiv.org/abs/2608.30680)
...
### [61] [Universal unconventional responses controlled by ferroaxial order](https://arxiv.org/abs/2608.30706)
...
### [62] [Fine structure of the M-center in Si](https://arxiv.org/abs/2608.30790)
...
### [63] [Role of self-coherence in single-electron phase contrast imaging](https://arxiv.org/abs/2608.30833)
...
### [64] [Stoner contributions to the magnon equation of motion](https://arxiv.org/abs/2608.30931)
...
### [65] [A MOF-reinforced self-foaming sponge for mechanically robust triboelectric membranes with improved resistance to humidity](https://arxiv.org/abs/2608.31019)
...
### [66] [Orbital and Spin Edelstein Effects in KTaO$_3$(110) Two-Dimensional Electron Gases](https://arxiv.org/abs/2608.31051)
...
### [67] [Strain-Tunable Spin Relaxation in Germanium from First Principles](https://arxiv.org/abs/2608.31169)
...
### [68] [Characteristic Mode Analysis of Composite Nanostructures using a Coupled System of Volume Integral and Hydrodynamic Equations](https://arxiv.org/abs/2608.29709)
...
### [69] [A wide-range temperature-dependent deep potential for sodium with near-experimental accuracy from melting to the critical point](https://arxiv.org/abs/2608.29826)
...
### [70] [Cartesian tensor equivariant machine-learning force field for spin-dependent atomistic simulations](https://arxiv.org/abs/2608.30338)
...
### [71] [OpenMUSTANC (MUltiple Scattering Theory At Nanoplasmonic Cavities): A MATLAB toolbox for the simulation of Plasmonic Sphere Aggregates](https://arxiv.org/abs/2608.30565)
