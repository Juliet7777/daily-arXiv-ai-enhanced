...
### [1] [A Gradient-Reconstruction Lattice Boltzmann Method for Compressible Navier--Stokes--Fourier Equations](https://arxiv.org/abs/2609.16361)
...
### [2] [Highly Parallel Real-Space Random Phase Approximation Using Lanczos Quadrature and Interpolation](https://arxiv.org/abs/2609.16408)
...
### [3] [Implicit Lagrangian Hydrodynamics with High-Order Finite Elements](https://arxiv.org/abs/2609.16424)
...
### [4] [An energy stable and accuracy-preserving finite volume scheme based on the SAV method with application to wall-distance computation](https://arxiv.org/abs/2609.16885)
...
### [5] [Adding slow magnetoacoustic mode to the HLL-type multi-state approximate Riemann solution](https://arxiv.org/abs/2609.17049)
...
### [6] [Two-Dimensional Materials toward CMOS-Compatible Scalable Quantum Hardware](https://arxiv.org/abs/2609.16172)
...
### [7] [Breaking the Wiedemann-Franz limit in thermoelectrics via separated flat bands](https://arxiv.org/abs/2609.16261)
...
### [8] [Orbital-resolved superexchange and topological magnon bands in MXene Fe$_2$C](https://arxiv.org/abs/2609.16530)
...
### [9] [Domain-wall energy governs coercivity in ordered and disordered additively manufactured Fe--49Co--2V](https://arxiv.org/abs/2609.16343)
...
### [10] [Full Minimal Coupling All-Electron Real-Time TDDFT for X-Ray-Matter Interactions](https://arxiv.org/abs/2609.16441)
...
### [11] [Total-energy-assisted Tight-binding Method Based on Density Functional Theory - Design Principles toward Transferability and Extrapolation](https://arxiv.org/abs/2609.16649)
...
### [12] [Scaling LLM Agents for Materials Design through Hierarchical Collective Reasoning](https://arxiv.org/abs/2609.16466)
...
### [13] [ZStar: An automated toolkit for polarization, Born effective charges, dielectric response, and infrared and Raman spectra calculations](https://arxiv.org/abs/2609.16802)
...
### [15] [Symbolic Ensemble Learning Enables Discovery of Fast Accurate Physics-Based Interatomic Potentials](https://arxiv.org/abs/2609.16526)
...
### [16] [Nonlinear electron-phonon interactions from first principles](https://arxiv.org/abs/2609.17433)
...
### [17] [Exotic centrosymmetric phase of acentric urea under high pressure](https://arxiv.org/abs/2609.16545)
...
### [19] [Nonlinear Photocurrent Spectroscopy and Polarization-Tunable Shift Current in the Layered Semiconductor $\mathrm{CuScP_2S_6}$](https://arxiv.org/abs/2609.16577)
...
### [20] [Application of Regional Chemical Potential Analysis to Si Adsorption on the Diamond (001) Surface](https://arxiv.org/abs/2609.16620)
...
### [21] [Electrical Probing of Sub-Néel Spin Dynamics in Two-Dimensional Antiferromagnets Using Graphene Heterostructures](https://arxiv.org/abs/2609.16725)
...
### [22] [The Closer, the Better: Engineering RGB Thermometric Performance in Tb3+, Eu3+-Doped MOFs](https://arxiv.org/abs/2609.16734)
...
### [23] [Electric-Field-Switchable Altermagnetism via Ligand Rotation in a d0 Metal-Organic Framework](https://arxiv.org/abs/2609.16749)
...
### [24] [Floquet Spin-Antiferroelectric Phase in Collinear Antiferromagnets](https://arxiv.org/abs/2609.16758)
...
### [25] [Interplay between Interlayer Shift and Twist: Twisted van der Waals Nanowires Driven by Rotational Twinning](https://arxiv.org/abs/2609.16771)
...
### [26] [Topological spin textures in 2D altermagnetic chromium chalcogenides: Interplay between magnetic frustration and Dzyaloshinskii-Moriya interaction](https://arxiv.org/abs/2609.16780)
...
### [27] [SpectraFit XPS: a free, browser-based application for X-ray photoelectron spectroscopy peak fitting and quantification](https://arxiv.org/abs/2609.16789)
*Yongsup Park*
...
### [28] [Fractional-Quantum Ferroelectrics: A Route to High-Mobility Ferroelectric Semiconductors](https://arxiv.org/abs/2609.16799)
...
### [29] [Probabilistic Deep Learning Framework for Phase Transformation Forecasting aided by In Situ High temperature Microscopy](https://arxiv.org/abs/2609.16940)
...
### [30] [Beyond the Binary Hull: Higher-Order Thermodynamic Stabilization in Inorganic Ternary Compounds](https://arxiv.org/abs/2609.17098)
*Pravan Omprakash*
...
### [31] [AI for Science with GPT-6 Astra: Thermal Design and Electrothermal Analysis of 2D CFET](https://arxiv.org/abs/2609.17123)
...
### [32] [A transfer-rod-mounted rotatable sample holder enabling a compact modular vacuum system for ion-beam milling, oblique magnetron sputtering, and co-sputtering](https://arxiv.org/abs/2609.17220)
...
### [33] [Higher order anharmonicity and polymorphism in the lattice thermal conductivity of transition metal dichalcogenides](https://arxiv.org/abs/2609.17270)
...
### [34] [High-Pressure Refractive Indices of NaCl, KCl, CaO, SrO, and MgO Reveal the Dependence of Anion Polarizability on Coordination Number and Bond Length](https://arxiv.org/abs/2609.17290)
...
### [35] [Bridging powder and multi-crystal diffraction with basis-adaptive texture tomography](https://arxiv.org/abs/2609.17299)
...
### [36] [Multiproperty Atomistic Characterization of a Synthesized Pyrazinic Nitrogen-Doped Porous Armchair Graphene Nanoribbon](https://arxiv.org/abs/2609.17305)
...
### [37] [Integrated quantum-secured cryptographic memory in customizable single nanodiamonds](https://arxiv.org/abs/2609.17329)
...
### [38] [Designing Homogeneous Ti-Nb-Fe-Sn $β$ Titanium Alloys by PBF-LB: A Pre-Alloyed Powder Blend Strategy](https://arxiv.org/abs/2609.17476)
...
### [39] [Enhanced thermal stability of SiGeSn by suppressing surface-mediated degradation](https://arxiv.org/abs/2609.17504)
...
### [40] [The chemistry of embrittlement: How hydrogen dwindles cohesion in iron during fracture](https://arxiv.org/abs/2609.17508)
*Aleksei Egorov*
...
### [41] [Quantum Critical Solids](https://arxiv.org/abs/2609.16147)
...
### [42] [Analytical solutions to the non-equilibrium Green's functions in large-$q$ SYK models](https://arxiv.org/abs/2609.16438)
*Jan C. Louw*
...
### [43] [Hartree-Fock Density-Matrix Renormalization Group for Very Long Chains](https://arxiv.org/abs/2609.16587)
*Steven R. White*
...
### [44] [La substitution studies on the heavy-fermion superconductor CeRh$_2$As$_2$](https://arxiv.org/abs/2609.17080)
