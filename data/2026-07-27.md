...
### [1] [Counting Edge Modes with the Higher Berry Curvature: A Bulk Topological Order Parameter for Quantum Spin Chains](https://arxiv.org/abs/2607.21705)
...
### [2] [Intrinsic single crystals of MnTe altermagnet](https://arxiv.org/abs/2607.21803)
...
### [3] [Hydrodynamic Memory and Long-Time Tails in Clean Frustrated Magnets](https://arxiv.org/abs/2607.21827)
...
### [4] [Quasi-Two-Dimensional Quantum Antiferromagnetism in the Distorted Honeycomb Compound KCuIn(PO4)2](https://arxiv.org/abs/2607.21868)
...
### [5] [Orbital Embedding and the Physical Definition of Quantum Geometry](https://arxiv.org/abs/2607.21882)
...
### [6] [GHz non-reciprocal optical conductivity in hematite ($α$-$\text{Fe}_2\text{O}_3$)](https://arxiv.org/abs/2607.22176)
...
### [7] [Zero-field magnetic structure of the antiferromagnetic metal EuSnP](https://arxiv.org/abs/2607.22245)
...
### [8] [When Can a Cavity Move a Mott Transition? A Spectral-Density Criterion within Gutzwiller Theory](https://arxiv.org/abs/2607.22283)
...
### [9] [Unconventional $\mathbb{Z}_2\times\mathbb{Z}_2\times\mathbb{Z}_2$ topological order in the kagome XY toric code](https://arxiv.org/abs/2607.22296)
...
### [10] [Quasiparticle interference as a tool to study quantum materials](https://arxiv.org/abs/2607.22487)
...
### [11] [Exactness of Symmetry-Broken Self-Interaction Correction in the Strongly-Correlated or Classical Limit: Harmonium as a Demonstration](https://arxiv.org/abs/2607.22488)
...
### [12] [Exact Neural-Network Representations of the Motzkin States](https://arxiv.org/abs/2607.22522)
...
### [13] [Generative and multimodal AI for materials prediction and design: Progress, challenges, and perspectives](https://arxiv.org/abs/2607.21660)
...
### [14] [Symmetry-Adapted Physical and Vibrational Properties of Ferroelectric Perovskite Oxides: Application to PbZrxTi1-xO3](https://arxiv.org/abs/2607.21682)
...
### [17] [Effect of Al-Zn alloy wafer grain boundary diffusion on the magnetism and microstructure of sintered NdFeB magnets](https://arxiv.org/abs/2607.21870)
*Xi Liu,Wenxi Fang*
...
### [18] [Unbiased Diffusion Monte Carlo for non local operators](https://arxiv.org/abs/2607.22273)
...
### [19] [Crystallization of pristine cubic ice from liquid at ambient pressure](https://arxiv.org/abs/2607.21872)
...
### [20] [Enhanced Curie temperature and room-temperature 50-nm skyrmions achieved in hexagonal ferromagnet Mn5Ge3+x synthesized via a high-pressure method](https://arxiv.org/abs/2607.21891)
...
### [21] [Ferrimagnetic Skyrmions in a Tetragonal Mn1.9Co0.1Sb Single Crystal at Room Temperature](https://arxiv.org/abs/2607.21894)
...
### [22] [Switchable Altermagnetism via Spin-Induced Improper Polarization](https://arxiv.org/abs/2607.21930)
...
### [23] [Quantitative Analysis of Composition and Contamination of Atomically Thin Materials by Recoil-Projectile Coincidence in Ion Transmission](https://arxiv.org/abs/2607.22089)
...
### [24] [Accelerating grain boundary modelling and simulation by automated pre-evaluation of the irreducible macroscopic representation](https://arxiv.org/abs/2607.22090)
*Wei Wan*
...
### [25] [Mechanical mapping of thin elastic films and living cells with spherical tip atomic force microscopy probes at large indentations](https://arxiv.org/abs/2607.22167)
...
### [26] [From Amorphous to Amorphous-Crystalline Mixed-Phase Boron Nitride: Evolution of the Thermal and Elastic Properties](https://arxiv.org/abs/2607.22185)
...
### [27] [Composition Anisotropy Drives Large Bulk Photovoltaic Fields Along the Non-polar Vertical Direction in 2D Hybrid Perovskite Ferroelectrics](https://arxiv.org/abs/2607.22261)
...
### [28] [SAGE-Net: Semantics-Augmented Geometric Encoder for Material Property Prediction](https://arxiv.org/abs/2607.22271)
...
### [29] [Substrate-metal interface engineering enhances TaN/Ta thin film superconducting resonator performance](https://arxiv.org/abs/2607.22294)
...
### [30] [Hidden Truchet Architecture in Zinc $p$-Hydroxybenzoate](https://arxiv.org/abs/2607.22307)
...
### [31] [Charge-Density-Wave Phase Transitions in Monolayer 1T-TaS2 from Universal Machine Learning Molecular Dynamics](https://arxiv.org/abs/2607.22316)
...
### [32] [Magnetic proximity-induced non-relativistic valley polarization](https://arxiv.org/abs/2607.22360)
...
### [33] [Mechanisms of Microstructural Evolution and Degradation in Aluminum under High-Damage Irradiation](https://arxiv.org/abs/2607.22364)
...
### [34] [Reversible photo-switching optical functionality in two-dimensional mixed-halide hybrid perovskites](https://arxiv.org/abs/2607.22476)
...
### [35] [Machine Learning Inference Limits of Routine Cement Characterization for CEM I Performance: Evidence From a Multi-Producer Dataset](https://arxiv.org/abs/2607.22512)
...
### [36] [On the Removal of Solver-Induced Dependencies in Momentum-Weighted Interpolation for Primal and Continuous-Adjoint Flow Solvers](https://arxiv.org/abs/2607.21736)
*Niklas Kühl*
...
### [37] [Learning Lattice Parameters from Powder X-Ray Diffraction Data Using Invariants](https://arxiv.org/abs/2607.21829)
...
### [38] [Producing a complete nuclear data library for adjoint Monte Carlo simulations](https://arxiv.org/abs/2607.22192)
...
### [39] [Hyperspatial Sampling: Circumventing Free-Energy Barriers via Replica Exchange with Extra Dimensions](https://arxiv.org/abs/2607.22417)
