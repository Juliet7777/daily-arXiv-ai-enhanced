...
### [2] [The role of weak interfaces in the tensile deformation and fracture of particle-filled polymers studied by phase-field model](https://arxiv.org/abs/2608.19031)
...
### [3] [Breaking the mutual exclusivity between metallicity and ferroelectricity in a non-polar covalent semiconductor via orbital selective doping](https://arxiv.org/abs/2608.18189)
...
### [4] [Writing and erasing skyrmions by single ultrafast laser pulses in monolayer Janus 2D magnets](https://arxiv.org/abs/2608.18278)
...
### [5] [Interface-Controlled Spin-Orbit Torques in Rare-Earth Synthetic Ferrimagnets Probed by Sagnac Magneto-Optics and Harmonic Hall Measurements](https://arxiv.org/abs/2608.18370)
...
### [6] [Magnetic interactions and origin of high Curie temperatures in high Mn content (MnSb2Te4)x(Sb2Te3)1-x quantum materials](https://arxiv.org/abs/2608.18378)
...
### [7] [Localized Excitons and Exciton-Phonon Coupling in Antiferromagnetic AgCrP2S6](https://arxiv.org/abs/2608.18394)
...
### [8] [Solidification-cell confinement of domain-wall pinning in additively manufactured ferromagnets](https://arxiv.org/abs/2608.18418)
...
### [9] [Optical poling of a quantum ferroelectric metal across the order-disorder phase transition](https://arxiv.org/abs/2608.18427)
...
### [10] [Room-Temperature Polarity Control of the Anomalous Nernst Effect in a High-Magnetic-Anisotropy Topological Nodal-Line MnAlGe](https://arxiv.org/abs/2608.18462)
...
### [11] [Room-temperature ferroelectrically switchable quantum geometry in few-layer WTe2 for complementary in-memory computing](https://arxiv.org/abs/2608.18467)
...
### [12] [Operando Raman probing of mode selective electron phonon coupling in two dimensional halide perovskites](https://arxiv.org/abs/2608.18513)
...
### [13] [Three-temperature atomistic spin-lattice dynamics in LAMMPS: a moment-consistent, fluctuation-dissipation-correct extension and its validation on ultrafast demagnetization and all-optical switching of GdFeCo](https://arxiv.org/abs/2608.18541)
...
### [14] [Néel-order-dependent transverse transport in noncoplanar antiferromagnet $\text{MnTe}_{2}$](https://arxiv.org/abs/2608.18564)
...
### [15] [Anti-spin Laue groups: classification of anti-altermagnets and their representative minimal models](https://arxiv.org/abs/2608.19056)
...
### [16] [Thickness-dependent degradation and optical access in epitaxial 2H-MoTe2 protected by metallic capping layers](https://arxiv.org/abs/2608.18629)
...
### [17] [Linear and nonlinear optical responses in the chiral multifold semimetal BeAu: A quantum-geometric perspective](https://arxiv.org/abs/2608.18720)
...
### [18] [Revisiting the topological properties of XMg2Bi2 (X = Ca, Sr, Ba, Yb and Eu)](https://arxiv.org/abs/2608.18729)
...
### [19] [On the temperature dependence of the optical band gap in the material system of lithium niobate and lithium tantalate](https://arxiv.org/abs/2608.18763)
...
### [20] [Detecting Magnetic Phase Transitions in Ion-Irradiated CrSBr Through Resonant Raman Scattering](https://arxiv.org/abs/2608.18909)
...
### [21] [Ultrafast order-selective electron imaging and spectroscopy](https://arxiv.org/abs/2608.18925)
...
### [22] [Ab initio-based Deep-Learning Prediction of Carrier Mobility in Strongly Anharmonic Materials](https://arxiv.org/abs/2608.19053)
...
### [23] [Local Structure and Dynamics of Three-Dimensional Covalent Organic Frameworks](https://arxiv.org/abs/2608.19106)
...
### [24] [JANUS: A Multi-modal Foundation Neural Sampler for Disordered Materials](https://arxiv.org/abs/2608.19116)
...
### [25] [Avalanche-like Plasticity in Complex Concentrated Alloys: A Review Across Scales](https://arxiv.org/abs/2608.19126)
...
### [26] [Sign-problem-resilient singular-value probe in determinant quantum Monte Carlo](https://arxiv.org/abs/2608.19028)
...
### [27] [Chern insulator boundary criticality](https://arxiv.org/abs/2608.18199)
...
### [28] [Finite-temperature Green's function cluster expansion from thermofield doubles: Breakdown of the polaron picture](https://arxiv.org/abs/2608.18267)
...
### [29] [Rare-earth spin textures and a route to electronic inhomogeneity in $Pr_2Ir_2O_7$](https://arxiv.org/abs/2608.18301)
...
### [30] [Topology is not silent in the transport noise of multiband bosons](https://arxiv.org/abs/2608.18527)
...
### [31] [Universal thermal breakdown of polaron coherence in one, two, and three dimensions](https://arxiv.org/abs/2608.18529)
...
### [32] [High-field fate of the Kitaev quantum spin liquid in $α$-RuCl$_3$](https://arxiv.org/abs/2608.18530)
...
### [33] [Hubb_DMFT and Wan2mb_DMFT: Continuous-Time Quantum Monte Carlo Solvers for Single- and Multi-Orbital Hubbard Model](https://arxiv.org/abs/2608.18540)
*A. A. Katanin*
...
### [34] [Transitions and Critical Divergences in Periodically Hopping Modulated Su-Schrieffer-Heeger Chains](https://arxiv.org/abs/2608.18706)
...
### [35] [Chiral bosonic mean-field Ansatz and spin dynamics in spin-1 Kitaev magnets](https://arxiv.org/abs/2608.19178)
...
### [36] [Unconventional bond- and current-density waves on hexagonal lattices](https://arxiv.org/abs/2608.19185)
