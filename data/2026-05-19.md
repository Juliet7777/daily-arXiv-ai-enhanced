...
### [1] [Basis-free neural-network geminal and Jastrow factors for variational Monte Carlo](https://arxiv.org/abs/2605.17083)
...
### [2] [Breakdown of Gradient-Flow Dynamics in Oscillator Ising Machines from Harmonic Misalignment](https://arxiv.org/abs/2605.17243)
...
### [3] [Physics Informed Neural Network-based Computational Method for Accelerating Time-Periodic Unsteady CFD Simulations](https://arxiv.org/abs/2605.18340)
...
### [4] [SPARC-atomSFE: Spectral finite-element package for atomic structure calculations in density functional theory](https://arxiv.org/abs/2605.18488)
...
### [5] [Simulation of S-parameters of general multilayer boxed PCBs with the method of moments and the scattering matrix algorithm](https://arxiv.org/abs/2605.18492)
...
### [6] [Ultrasonic determination of crystallographic texture by transmitted field fitting regardless of medium dispersivity](https://arxiv.org/abs/2605.16556)
...
### [7] [Crystal growth and characterization of the ultra-high temperature substrate $\mathrm{Ta_{1-x}Hf_{x}C_{0.5}}$](https://arxiv.org/abs/2605.16583)
...
### [8] [Machine Learning Approaches to Point Defects in Non-Metallic Materials: A Review of Methods](https://arxiv.org/abs/2605.16611)
...
### [9] [Non-linear diffusion and inhomogeneity of the magnetic field in single-turn coils: Insights from 3D multiphysics modeling](https://arxiv.org/abs/2605.16659)
...
### [10] [Learning inelastic constitutive models from stress-strain data under hard thermodynamic constraints](https://arxiv.org/abs/2605.16837)
*Filippo Masi*
...
### [11] [Interface engineering of the anomalous Hall effect in Ni-based heterostructures](https://arxiv.org/abs/2605.16936)
...
### [12] [An Efficient Approach for Calculating Free Energy in Molecular Dynamics: Demineralization of Hydroxyapatite as a Case Study](https://arxiv.org/abs/2605.16957)
...
### [13] [First-principles calculations of electrical conductivities of edge-modified graphene nanoribbons: strain effect](https://arxiv.org/abs/2605.16965)
...
### [14] [Causal Anomaly Detection for Lithium-Ion Battery Degradation](https://arxiv.org/abs/2605.17334)
...
### [15] [Spatial statistics for screening molecular structures](https://arxiv.org/abs/2605.17147)
...
### [16] [Optical, vibrational, and electronic properties of semiconducting YbN](https://arxiv.org/abs/2605.17166)
...
### [17] [Electronic mechanism of sub-100-fs demagnetization induced by a femtosecond light pulse](https://arxiv.org/abs/2605.18638)
...
### [18] [Structure of Molten FeCl2 and FeCl3](https://arxiv.org/abs/2605.17207)
...
### [19] [Observation of universal thermopolarization effect in insulators](https://arxiv.org/abs/2605.17224)
...
### [20] [On-chip detection of anisotropic thermopolarization in quartz](https://arxiv.org/abs/2605.17226)
*Shuichi Iwakiri,Yasumitsu Miyata,Takao Mori*
...
### [21] [Frequency renormalization and its effects in nonlinear phononics with $Q_RQ_{IR}^{2}$-type coupling](https://arxiv.org/abs/2605.17241)
*Yijie Zeng*
...
### [22] [Anomalous thermal and elastic properties of an epitaxial NiTi film exhibiting R-phase](https://arxiv.org/abs/2605.17553)
...
### [23] [Microstructure evolution during rapid solidification of hypoeutectic Al-Ag alloys near absolute stability](https://arxiv.org/abs/2605.17576)
...
### [24] [A comparative first-principles investigation of bilayer NbOX2 (X=Cl, Br, I) for Photocatalytic water splitting applications](https://arxiv.org/abs/2605.17616)
...
### [25] [Finite-width adiabatic shear banding and dislocation patterning in mesoscale polycrystalline aggregates](https://arxiv.org/abs/2605.17619)
...
### [26] [Ferroelectric polarization controlled orbital Hall conductivity in a higher-order topological insulator: \textit{d1T}-phase monolayer MoS$_2$](https://arxiv.org/abs/2605.17722)
...
### [27] [Anomalies in the thermal conductivity of honeycomb antiferromagnet MnPS$_{3}$](https://arxiv.org/abs/2605.17785)
...
### [28] [Metal-free heteroatom doping of carbon nitride for enhanced photocatalytic hydrogen peroxide production](https://arxiv.org/abs/2605.17897)
...
### [29] [Indicators for phonon hydrodynamics from first principles predictions of thermal conductivity](https://arxiv.org/abs/2605.17947)
...
### [30] [Real-time Multi-instrument Autonomous Discovery of Novel Phase-change Memory Materials](https://arxiv.org/abs/2605.18033)
...
### [31] [Combinatorial Survey of Structural Phase Distribution and Magnetism in Fe-Ge-Te Composition-spread Thin Film Libraries](https://arxiv.org/abs/2605.18037)
...
### [32] [Chemo-mechanical coupling stabilizes mixed $\mathrm{Ag}_{x}\mathrm{Cu}_{1-x}\mathrm{GaSe}_{2}$ solar-cell absorbers: Insights from Monte-Carlo simulations assisted by ab initio informed machine-learning potentials](https://arxiv.org/abs/2605.18057)
...
### [33] [Characterisation of fire-damaged batteries,implications for recycling](https://arxiv.org/abs/2605.18183)
...
### [34] [High-Density Horizontal Arrays of Single-Chirality Carbon Nanotubes](https://arxiv.org/abs/2605.18195)
...
### [35] [First-principles investigation of small polarons in rhombohedral NaNbO$_{3}$](https://arxiv.org/abs/2605.18200)
...
### [36] [Short-range order in the CoCrFeMnNi high-entropy alloy from cluster expansion](https://arxiv.org/abs/2605.18219)
...
### [37] [Why hole polaron formation on oxygen is limiting the Fermi level in Fe acceptor doped BaTiO$_{3}$ under oxidizing conditions](https://arxiv.org/abs/2605.18258)
...
### [38] [Tuning the Charge Transfer of Transition Metal Dichalcogenides via Misfit Layer Compounds](https://arxiv.org/abs/2605.18317)
...
### [39] [Metastable Cu$_{1-x}$CrTe$_2$ -- Completing the copper chromium delafossite series through soft chemistry](https://arxiv.org/abs/2605.18400)
...
### [40] [Epitaxial growth and magnetic phase transitions in non-centrosymmetric EuPdSi$_3$ thin films](https://arxiv.org/abs/2605.18418)
...
### [41] [Spatially-Localized Second Harmonic Generation via Spin Wave Concentration in Patterned YIG Structures](https://arxiv.org/abs/2605.18479)
...
### [42] [Termination-Preserved Ultra-high Tunneling Magnetoresistance in Altermagnetic KV2Se2O](https://arxiv.org/abs/2605.18493)
...
### [43] [Defect Control via Cu Enrichment Enhances Multifunctional Properties in the Polar Semiconductor Cu1+xMn1-ySiTe3](https://arxiv.org/abs/2605.18584)
...
### [44] [Correlation-Driven Spin Reorientation via Competing Anisotropy Channels in CrPS4](https://arxiv.org/abs/2605.16541)
...
### [45] [Revealing Hund superdispersion with tunneling spectroscopy](https://arxiv.org/abs/2605.16580)
...
### [46] [Systematic dynamical mean-field theory study of 3d perovskite oxides with uniform Coulomb interactions](https://arxiv.org/abs/2605.16771)
...
### [47] [Finite-Temperature Spin Exchange-Correlation Kernel of the Uniform Electron Gas](https://arxiv.org/abs/2605.16888)
...
### [48] [Specific heat and susceptibility of S=1/2 antiferromagnets on square, triangular, and kagome lattices](https://arxiv.org/abs/2605.17420)
*Chisa Hotta*
...
### [49] [Partial Kondo Screening Solves the Mystery of Rare Earth Tetraborides](https://arxiv.org/abs/2605.17469)
...
### [50] [Finite-frequency anomaly-induced electromechanical response of Dirac fermions in deformed graphene](https://arxiv.org/abs/2605.17632)
*Ara Sedrakyan*
...
### [51] [Graph-Theoretic Detection of Hilbert Space Fragmentation](https://arxiv.org/abs/2605.17951)
...
### [52] [$5/9-$Magnetization Plateau and Spin Supersolidity in YCu$_3$(OD)$_{7-x}$Br$_{2+x}$ under Magnetic Fields up to 120~T](https://arxiv.org/abs/2605.17995)
...
### [53] [Exact Organization of Density Matrices and Entanglement Structure in the Kitaev Spin Liquid](https://arxiv.org/abs/2605.18002)
...
### [54] [Taming the 3D Wilson-Fisher Fixed Point via Nonlocal Effective Action](https://arxiv.org/abs/2605.18148)
...
### [55] [Pressure Effects on CeMnSi: Evolution of Ce 4f and Mn 3d Electronic States and Negative Thermal Expansion](https://arxiv.org/abs/2605.18230)
...
### [56] [Charge order on a triangular lattice with Mott physics and arbitrary charge density](https://arxiv.org/abs/2605.18575)
...
### [57] [Frustration from Localized Zhang-Rice States: A Unified Theory of Doping-Driven Magnetic Transitions in Cuprates](https://arxiv.org/abs/2605.18453)
...
### [58] [Interlayer electronic coherence links magnetism and superconductivity in Ruddlesden-Popper nickelates](https://arxiv.org/abs/2605.18524)
