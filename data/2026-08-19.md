...
### [5] [PowderLine: a programmatic powder diffraction analysis application](https://arxiv.org/abs/2608.17009)
...
### [6] [Over what length scale does an inorganic substrate perturb the structure of a glassy organic semiconductor?](https://arxiv.org/abs/2608.17089)
...
### [8] [Temperature-Induced Reorganization of Supported Zn$_3$ Clusters on Cu(111): From Minimum-Energy Structures to Finite-Temperature Ensembles](https://arxiv.org/abs/2608.17149)
...
### [9] [Discovery of novel magnetic Y-Mn-B compounds via advanced machine learning guided framework](https://arxiv.org/abs/2608.17200)
...
### [10] [Windmill Spin Dynamics and Its Induced Anomalous Hall Effect in Noncollinear Antiferromagnet Mn3Sn](https://arxiv.org/abs/2608.17225)
...
### [11] [Fresnel diffraction imaging of surface nanostructure using coherent resonant X-ray scattering](https://arxiv.org/abs/2608.17377)
...
### [12] [Giant Bandgap Pulsation Driven by Hotspot Breathing Phonons in a Flat-Band Solid](https://arxiv.org/abs/2608.17408)
...
### [13] [Atomistic Structure Generation and Neural-Network Screening of Hard Carbons to Identify High-Capacity Sodium Storage](https://arxiv.org/abs/2608.17716)
...
### [14] [Intra-atomic magnetic octupoles and their coupling to cluster magnetic octupoles in Chiral antiferromagnets Mn$_3$Sn](https://arxiv.org/abs/2608.17461)
...
### [15] [Growth of Altermagnetic α-MnTe Films: Substrate Variation and Surface Modification](https://arxiv.org/abs/2608.17513)
...
### [16] [Multiple topological electronic and phononic quasiparticle excitations in hexagonal TTe (T=Hf, Zr & Ti) crystals](https://arxiv.org/abs/2608.17557)
...
### [17] [Chiral Spinterfaces as an Overlooked Component of the Chiral-Induced Spin Selectivity Effect](https://arxiv.org/abs/2608.17608)
...
### [18] [Quantized Spin Hall Effect in Three-Dimensional Nodal-Ring Semimetal: Geometric Scaling and Symmetry-Engineered Spin Response](https://arxiv.org/abs/2608.17627)
...
### [19] [Vacancy-Driven Electronic Reconstruction in Monolayer PtSe$_2$: Formation Thermodynamics and Charge States](https://arxiv.org/abs/2608.17720)
...
### [20] [Active learning molecular beam epitaxy of complex quantum materials](https://arxiv.org/abs/2608.17742)
...
### [21] [Polarization-Dependent Raman Selection Rules in Sb$_2$S$_3$ from First Principles and Experiment](https://arxiv.org/abs/2608.17786)
...
### [22] [Defect Geometry Selects Polar and Anomalous Hall Phases in Two-Dimensional Altermagnets](https://arxiv.org/abs/2608.17788)
...
### [23] [Electron transport in amorphous materials: from localization to predictive transport modeling](https://arxiv.org/abs/2608.17814)
*Yeonghun Lee*
...
### [24] [Optical decoherence in Er$^{3+}$-doped CeO$_2$ spin qubit platforms](https://arxiv.org/abs/2608.17867)
...
### [25] [Energy-efficient, Reconfigurable Optoelectronic Artificial Synapses Based on MoWS$_2$ Alloy for Pattern Recognition and Color Image Filtering Applications](https://arxiv.org/abs/2608.18013)
