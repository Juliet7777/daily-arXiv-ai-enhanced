...
### [13] [Engineering Chirality in Halide Perovskites](https://arxiv.org/abs/2608.13053)
...
### [18] [Boundary phases and thermodynamics of the Kondo spin-$s$ chain: from overscreened Kondo to boundary-bound states](https://arxiv.org/abs/2608.12453)
...
### [19] [Fermionic Anomalies of Finite Symmetries on Lattices](https://arxiv.org/abs/2608.12455)
...
### [20] [Revisiting magnon bound states: ferro-antiferromagnetic $J_1\!-\!J_2$ square-lattice model](https://arxiv.org/abs/2608.12459)
...
### [25] [Accelerating a Strong-Coupling Non-Equilibrium Steady-State Impurity Solver using (Quantics) Tensor Trains](https://arxiv.org/abs/2608.13146)
...
### [26] [Topology and Quantum-Spin-Classical-Spin Crossover of the Gapped Kondo Effect](https://arxiv.org/abs/2608.13065)
...
### [27] [Magnetism in antiperovskite (Li$_2$\textit{M})\textit{Ch}O (\textit{M} = Fe, Mn, Co; \textit{Ch} = S, Se) diluted magnets with fixed 1/3 filling: the key role of magnetic anisotropy](https://arxiv.org/abs/2608.13111)
...
### [30] [TCAD Cryogenic Model Parameters Calibration based on 65 nm NMOS Experimental Data](https://arxiv.org/abs/2608.12692)
...
### [31] [A discrete duality finite volume method with harmonic average for semiconductor drift-diffusion equations](https://arxiv.org/abs/2608.12808)
...
### [32] [Using Diffusion Models to Estimate Uncertainties in Analytic Continuation](https://arxiv.org/abs/2608.13123)
...
### [33] [Modeling Bond-Dependent Kitaev-like interaction in 2D Edge-Sharing Tetrahedral Magnets: FeX (X=Te, Se)](https://arxiv.org/abs/2608.13427)
...
### [34] [Characteristic Mode Analysis of Plasmonic Nanostructures Using Hydrodynamic Volume Integral Equation](https://arxiv.org/abs/2608.13435)
