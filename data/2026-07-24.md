...
### [1] [A Single-Trace Surface Integral Equation Solver for Simulation of Open Bianisotropic Metasurfaces Described by Generalized Sheet Transition Conditions](https://arxiv.org/abs/2607.20659)
...
### [2] [Matrix-free phase-field modeling of fracture in micromechanical testing simulations of inelastic materials](https://arxiv.org/abs/2607.21150)
...
### [3] [Cycle-Consistent and Uncertainty-Aware Neural Surrogates for Tokamak Edge Plasmas](https://arxiv.org/abs/2607.21407)
...
### [4] [Lithium-Projected Phonon Spectral Distributions as Robust Descriptors of Ionic Conductivity in Solid Electrolytes](https://arxiv.org/abs/2607.20591)
...
### [5] [Magnetic ground states of CrPS$_4$ and NiPS$_3$ monolayers from long-range exchange interactions](https://arxiv.org/abs/2607.20631)
...
### [6] [A high-dimensional neural network potential for finite-temperature phenomena in NiTi martensite](https://arxiv.org/abs/2607.20681)
...
### [7] [Machine learning based prediction of optical properties in two-dimensional Mo-W-S-Se-Te transition-metal dichalcogenide alloys through physics-informed sampling](https://arxiv.org/abs/2607.21246)
...
### [8] [Analytical Forces from the Bethe-Salpeter Equation for Large-Scale Excited-State Relaxation](https://arxiv.org/abs/2607.20728)
...
### [9] [First-principles calculation of electron-phonon spectral functions for defects using phonon interpolation](https://arxiv.org/abs/2607.20788)
...
### [10] [Photo-induced currents and short-term memory for reservoir computing in a ferroelectric semiconductor](https://arxiv.org/abs/2607.20810)
...
### [11] [MatDiffract: A Material-Informed Automated Analysis Platform for X-ray Powder Diffraction](https://arxiv.org/abs/2607.20880)
...
### [12] [Long- and Short-Range Anion Order in SrTiO$_{3-x}$H$_x$ Perovskite Oxyhydrides: DFT+$U$ Sensitivity and HSE06 Cluster Expansion](https://arxiv.org/abs/2607.20885)
...
### [13] [Orbital Hall Effect Enables Field-Free Magnetization Reversal in Ferrimagnets without Additional Conversion Layer](https://arxiv.org/abs/2607.20888)
...
### [14] [Magneto-Caloric effect and Multiple magnetic phases in Al doped Ni2MnSn0.75Al0.25 Heusler Alloys](https://arxiv.org/abs/2607.21181)
...
### [15] [Visualizing Microwave-Driven Dynamics of Antiskyrmions and Surface Skyrmions](https://arxiv.org/abs/2607.20904)
...
### [17] [Complete Raman Tensor Determination in Birefringent $β$-Ga$_2$O$_3$ by Single-Stage Hyperspectral Analysis of Polarization Angle-Resolved Raman Spectra](https://arxiv.org/abs/2607.21045)
...
### [18] [Tunnel magnetoresistance effect with a Cr-doped $\mathrm{RuO_{2}}(110)$ altermagnet](https://arxiv.org/abs/2607.21092)
...
### [19] [Lifetime effects and satellites in the photoelectron spectrum of platinum metal](https://arxiv.org/abs/2607.21298)
...
### [20] [Monte Carlo Studies of Twisted Bilayer Graphene: Strain and Thermal Fluctuations](https://arxiv.org/abs/2607.20619)
...
### [21] [Colloquium: Semi-Dirac Fermions in Quantum Matter](https://arxiv.org/abs/2607.20627)
...
### [22] [Ferromagnetic transition in a chiral spin chain](https://arxiv.org/abs/2607.20629)
...
### [23] [Doping-induced Ferromagnetic order and its unusual evolution to Helical Antiferromagnetic Order in Sr(Ni$_{1-x}$Co$_x$)$_2$P$_2$](https://arxiv.org/abs/2607.20663)
...
### [24] [Exact Nagaoka-to-spiral transition in the doped infinite-U triangular lattice](https://arxiv.org/abs/2607.20726)
...
### [25] [Gaplessness indicator by topologically trivial twisting operators](https://arxiv.org/abs/2607.20944)
...
### [26] [Thermal Hall Resistivity as a Unifying Description of Phonon Thermal Hall Effect in Various Insulators](https://arxiv.org/abs/2607.21157)
...
### [27] [Long-wavelength density response and momentum resolution in strange-metal charge spectroscopy](https://arxiv.org/abs/2607.21206)
*Ilmo Sung*
...
### [28] [Shiba duality and $η$-altermagnetism: Pairing and charge orders in bipartite attractive Hubbard models](https://arxiv.org/abs/2607.21430)
*Yu-Ping Lin*
...
### [29] [Interlayer interactions reshape charge-density wave through electronic elasticity in 4H$_{\mathrm{b}}$-TaS$_2$](https://arxiv.org/abs/2607.21470)
...
### [30] [Pseudogap formation in the moderate correlated layered attractive Hubbard model](https://arxiv.org/abs/2607.21478)
...
### [31] [Strong correlations and local self-energies from on-site ensembles](https://arxiv.org/abs/2607.21490)
...
### [32] [Symmetry and Quantum Geometry in Bloch Bands](https://arxiv.org/abs/2607.21581)
