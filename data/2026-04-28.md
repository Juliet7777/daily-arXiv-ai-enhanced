...
### [2] [Thermodynamic Modeling of Pure Elements from 0 K with Uncertainty Quantification using PyCalphad and ESPEI](https://arxiv.org/abs/2604.22910)
...
### [3] [Large language model-enabled automated data extraction for concrete materials informatics](https://arxiv.org/abs/2604.22938)
...
### [4] [Chirality Transfer to the Centrosymmetric Magnetic Sublattice in the Hybrid Perovskite (R)-/(S)-3-Fluoropyrrolidinium Copper(II) Chloride](https://arxiv.org/abs/2604.22952)
...
### [5] [Sustainability-informed materials design](https://arxiv.org/abs/2604.22987)
...
### [6] [A Single Twist-Angle Selection Method for the Electronic Structure of Bilayer Materials](https://arxiv.org/abs/2604.23405)
...
### [9] [Spin excitation of the Heisenberg antiferromagnet with frustration: from the bounce-lattice antiferromagnet through the maple-leaf-lattice antiferromagnet to the exact-dimer system](https://arxiv.org/abs/2604.24055)
...
### [10] [Ultra-High Dynamic Strength of Additively Manufactured GRX-810 Under Coupled Conditions of High Strain Rate and Elevated Temperature](https://arxiv.org/abs/2604.23143)
...
### [11] [Electron-phonon coupling across the TMD/hBN van der Waals interface](https://arxiv.org/abs/2604.24139)
...
### [12] [Weak Polar Optical Phonon Scattering Decouples Electron and Phonon Transport in Layered Thermoelectric Materials](https://arxiv.org/abs/2604.23328)
...
### [13] [From Data-Driven Models to Physical Insight: Vibrational Entropy Governed by Atomic Volume](https://arxiv.org/abs/2604.23369)
...
### [14] [Electronic Spectroscopy of Atomic Defects in Molybdenum Disulfide under Ambient Conditions](https://arxiv.org/abs/2604.23391)
...
### [17] [Magnetic interactions and spin orders in Cr$_8$ and V$_8$ ring-shaped molecular magnets from non-collinear ab initio calculations](https://arxiv.org/abs/2604.23565)
...
### [18] [Modeling the Zero-Phonon Line of Strained SnV Centers in Diamond; Including Reflections on Computational Cost and Accuracy](https://arxiv.org/abs/2604.23715)
*Danny E. P. Vanpoucke*
...
### [19] [Attention Is Not All You Need for Diffraction](https://arxiv.org/abs/2604.23811)
...
### [20] [Accelerating Quantum Materials Characterization: Hybrid Active Learning for Autonomous Spin Wave Spectroscopy](https://arxiv.org/abs/2604.23821)
*William Ratcliff*
...
### [21] [Optical Properties of Indium-Gallium-Oxide Microcrystalline Alloy Films: From the Visible to the Deep-UV](https://arxiv.org/abs/2604.23884)
...
### [22] [Nearly Isotropic Magnon Transport in Epitaxial Lithium Aluminum Ferrite Thin Films](https://arxiv.org/abs/2604.23943)
...
### [23] [Three-dimensional topological ferroelectrics](https://arxiv.org/abs/2604.23969)
...
### [24] [Room-temperature shape-memory effect in Sr(Ni$_{1-x}$Cu$_x$)$_2$P$_2$](https://arxiv.org/abs/2604.24019)
...
### [25] [Interfacial breathing as a dynamic failure law in all-solid-state batteries: amplitude, phase lag and dual-timescale memory as design principles](https://arxiv.org/abs/2604.24075)
*Changdeuck Bae*
...
### [26] [Understanding Damping Mechanisms via Spin Diffusion Length in Low-damping Li$_{0.5}$Al$_{1.0}$Fe$_{1.5}$O$_4$ Spinel Ferrite Thin Films](https://arxiv.org/abs/2604.24094)
...
### [27] [Characterizing Fill Factor Limitations in Perovskite-Silicon Tandem Solar Cells](https://arxiv.org/abs/2604.24098)
...
### [28] [Phase transformation kinetics in MoS2 governed by S-S repulsive interactions and defect-interface compatibility](https://arxiv.org/abs/2604.24209)
...
### [29] [Nitrogen doping induced metal-insulator transition with iso-symmetric character in rutile VO2](https://arxiv.org/abs/2604.24240)
...
### [30] [Atomistic Mechanisms of Temperature-Dependent Ion Track Formation in Gallium Nitride under Swift Heavy Ion Irradiation](https://arxiv.org/abs/2604.24288)
...
### [31] [Mapping Reversal Pathways and Interaction Fields in Artificial Spin Ice](https://arxiv.org/abs/2604.24382)
...
### [32] [Electronic and optical properties of arsenic monolayers: from planar honeycomb to the puckered phase](https://arxiv.org/abs/2604.24585)
...
### [33] [Step- and terrace-resolved crystal truncation rod scattering from vicinal surfaces under coherent heteroepitaxy](https://arxiv.org/abs/2604.24604)
...
### [34] [Physical Basis for Band Transport and Dimensionality in Amorphous Oxide Semiconductor Field-Effect Transistors](https://arxiv.org/abs/2604.24641)
...
### [35] [A step-by-step workflow to extract the genuine circular dichroism of thin films](https://arxiv.org/abs/2604.24653)
...
### [36] [Bottom-up realization of a type-II organic-TMD heterointerface: Pentacene on monolayer WS2](https://arxiv.org/abs/2604.24671)
...
### [37] [Improved Electrochemical Performance and Diffusion kinetics by Boron-doping in Na$_{0.66}$Mn$_{0.8}$Fe$_{0.2}$O$_{2}$ Layered Cathodes for Sodium-Ion Batteries](https://arxiv.org/abs/2604.24683)
...
### [38] [Visons in Kitaev Spin Liquids with Majorana Fermi Surfaces](https://arxiv.org/abs/2604.23014)
...
### [39] [Exact momentum-space analysis of small spin-1/2 $J_1$-$J_2$ rings](https://arxiv.org/abs/2604.23149)
*Zimeng Li,Ning Wu*
...
### [40] [Grassmann time-evolving matrix product operators for fermionic impurities coupled to a superconducting bath](https://arxiv.org/abs/2604.23301)
...
### [41] [Coherent spin waves in a maximal entropy phase](https://arxiv.org/abs/2604.23597)
...
### [42] [Testing the robustness of topological quantities evaluated from the modular Hamiltonian for a given wavefunction](https://arxiv.org/abs/2604.24058)
...
### [43] [Dichroic Raman probes for chiral edge modes](https://arxiv.org/abs/2604.24208)
...
### [44] [Umklapp corrections to Landau damping and conditions for non-trivial modifications to quantum critical transport](https://arxiv.org/abs/2604.24274)
*Vibhu Mishra*
...
### [45] [Field-induced jammed polyhex spin liquid in the honeycomb Ising antiferromagnet](https://arxiv.org/abs/2604.24687)
...
### [46] [Control of the Néel vector in the quantum antiferromagnetic honeycomb lattice](https://arxiv.org/abs/2604.24695)
...
### [47] [Non-Abelian Particle-Loop, Fracton, and Planon Condensation in Cage-Net Models](https://arxiv.org/abs/2604.24755)
...
### [48] [On mathematical characterization of a Bessel functions-based passive element in electronic circuits](https://arxiv.org/abs/2604.22798)
...
### [49] [Learning subgrid interfacial area in two-phase flows with regime-dependent inductive biases](https://arxiv.org/abs/2604.23946)
...
### [50] [An axion framework for Particle-in-Cell codes with Monte-Carlo sampling: emission, absorption, and detailed balance in plasmas](https://arxiv.org/abs/2604.24627)
...
### [51] [Microstructure engineering of Ti-6Al-4V in laser powder bed fusion via 1D thermal modeling and supporting experiments](https://arxiv.org/abs/2604.24669)
