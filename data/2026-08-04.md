...
### [8] [Machine-Learning-Accelerated Metallene Stabilization from High-Throughput Sandwich Modeling](https://arxiv.org/abs/2608.01779)
...
### [9] [An essay on $d_0$ in neutron-based strain measurement techniques: equilibrium-based methods for non-destructive $d_0$ estimation](https://arxiv.org/abs/2608.00362)
...
### [10] [The AFLOW Library of Crystallographic Prototypes: Part 5](https://arxiv.org/abs/2608.00425)
...
### [11] [Machine Learning Compatible CALPHAD-type Optimization from Phase Equilibria by Auto-differentiation](https://arxiv.org/abs/2608.00516)
...
### [12] [Spin- and Angle-resolved Photoelectron Spectroscopy Study of the Quantum Spin Hall Insulator Bismuthene and its Precursor Phase](https://arxiv.org/abs/2608.00526)
...
### [13] [Uncertainty-guided active learning for surrogate prediction of stream-finishing wear fields](https://arxiv.org/abs/2608.00593)
...
### [14] [Ultrahigh Intrinsic Hole Mobilities in $M$N$_2$ ($M$= Mo and W) at Room Temperature](https://arxiv.org/abs/2608.00699)
...
### [15] [Atomic-scale reactivity of the CeO$_2$~(100) surface reconstructions by scanning probe microscopy](https://arxiv.org/abs/2608.00704)
...
### [16] [Conditional grain-graph diffusion for property-guided inverse design of polycrystalline microstructures](https://arxiv.org/abs/2608.00707)
...
### [17] [High-speed and high-gain graphene photovoltaic phototransistor gated by a van der Waals heterojunction](https://arxiv.org/abs/2608.00771)
...
### [18] [A Large-scale Parallel Implementation of Quasi-Four-Component Relativistic Density Functional Theory with Numeric Atom-centered Orbitals](https://arxiv.org/abs/2608.00773)
...
### [19] [Non-relativistic spin splitting in a triangular metal-excess magnet Fe$_{1+δ}$Sb](https://arxiv.org/abs/2608.00871)
...
### [21] [EBSD and Subtle Crystallographic Differences - A Study of Resolving Interlayer Spacings in Nb-Ni and Nb-Co mu-phases](https://arxiv.org/abs/2608.01210)
...
### [22] [Twist-induced magnetic topological phase transition in stacked altermagnetic CrO](https://arxiv.org/abs/2608.01235)
...
### [23] [Why Ammoniated Lithium Borohydrides Liquefy and Resolidify?](https://arxiv.org/abs/2608.01266)
...
### [24] [Synthesis and structural validation of close-to-stoichiometric NiTe$_2$ single crystals](https://arxiv.org/abs/2608.02334)
...
### [26] [Gradient expansion approximation of the inhomogeneous electron-gas revisited: Higher-order corrections](https://arxiv.org/abs/2608.02524)
...
### [27] [Physics-Informed Neural Networks for Sparse Strain-Field Reconstruction in 4D-STEM](https://arxiv.org/abs/2608.01601)
...
### [40] [Mitigating ray effects in rarefied flow simulations using an ensemble-of-subproblems strategy with stochastic discrete velocities](https://arxiv.org/abs/2608.00514)
...
### [41] [A memory-efficient deterministic method for multiscale gas flows using an ensemble-of-subproblems strategy with stochastic discrete velocities](https://arxiv.org/abs/2608.00521)
*Shuyang Zhang,Weidong Li,Ming Fang,Zhaoli Guo*
...
### [42] [Consistent and bound-preserving finite-volume WENO scheme for compressible two-/$N$-phase flows with Phase-Field mechanism](https://arxiv.org/abs/2608.00746)
*Ziyang Huang*
...
### [43] [Rhombohedral Graphene: A Tale of Many Crystals](https://arxiv.org/abs/2608.00167)
...
### [44] [Shape of Wigner Crystals and Hole Self-Doping in a Mexican-Hat Dispersion](https://arxiv.org/abs/2608.00170)
...
### [45] [Chiral Magnon Mixing by Symmetry-Breaking in Collinear Ferrimagnets](https://arxiv.org/abs/2608.00210)
...
### [46] [Interplay of spin-orbit coupling, crystal field splitting and correlations: a ghost rotationally invariant slave boson treatment](https://arxiv.org/abs/2608.00254)
...
### [47] [Breakdown of Universal Whirling Order in a Heisenberg Tsai-Type Approximant](https://arxiv.org/abs/2608.00467)
...
### [48] [Negative thermal expansion, lattice dynamics, and complex magnetism in TbFeO$_3$](https://arxiv.org/abs/2608.00469)
...
### [49] [Spin-orbit-entangled frustrated magnetism in fcc Ba$_2$(Yb,Nd)NbO$_6$ double perovskites](https://arxiv.org/abs/2608.01022)
...
### [50] [Magnetic circular dichroism of THz modes and selection rules of Raman-active optical phonons in the polar altermagnet candidate \ce{Mn2Mo3O8}](https://arxiv.org/abs/2608.01062)
...
### [51] [Pressure-induced self-doping and Fermi surface reconstruction in UAs2](https://arxiv.org/abs/2608.01244)
...
### [52] [All-Electric Topological Phase Transitions in Proximity-Coupled Bilayer MnBi2Te4 Heterostructures](https://arxiv.org/abs/2608.01312)
...
### [53] [Quantum geometry and RKKY in flat bands](https://arxiv.org/abs/2608.01363)
...
### [54] [Emergent modular Luttinger liquid from spin-partitioned entanglement in the one-dimensional Hubbard model](https://arxiv.org/abs/2608.01817)
...
### [55] [Topological Defects in Triple-$Q$ Magnetic Orders: A Fixed-Lattice Homotopy Classification](https://arxiv.org/abs/2608.01838)
*Jin-Tao Jin,Yi Zhou*
...
### [56] [Diodes and capacitors for the transport of monopoles in fragmented spin ice](https://arxiv.org/abs/2608.01883)
...
### [57] [Microscopic magnetic phase evolution in the Weyl semimetal Mn$_3$Sn revealed by $μ^+$SR](https://arxiv.org/abs/2608.01892)
...
### [58] [Pressure-Driven Evolution of Electronic and Magnetic Correlations in Bilayer Nickelate La3Ni2O7](https://arxiv.org/abs/2608.02261)
...
### [59] [Long and short time linear response of metals: a geometric approach](https://arxiv.org/abs/2608.02298)
...
### [60] [Optimized Tensor-Network Renormalization for Quantum Dynamics: Resolving the Spectral Function of $\mathrm{K_2Co(SeO_3)_2}$](https://arxiv.org/abs/2608.02473)
