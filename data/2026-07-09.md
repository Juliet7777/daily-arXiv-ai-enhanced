...
### [1] [Origin of the reaction temperature in solid-state materials synthesis](https://arxiv.org/abs/2607.06685)
...
### [2] [Fluctuation-Driven Enhancement of Spin-Orbit Torque near the Curie Temperature of Ultrathin Ferromagnets](https://arxiv.org/abs/2607.06703)
...
### [3] [Physical exact conditions as regularizers for exchange-correlation in solids and surface chemistry](https://arxiv.org/abs/2607.06729)
*Johannes Voss*
...
### [4] [Spin-orbit magnetism in altermagnets](https://arxiv.org/abs/2607.06730)
...
### [5] [First-Principles Investigation of the Al-V Phase Diagram](https://arxiv.org/abs/2607.06741)
...
### [6] [Symmetry-Enforced Chiral Phonons in Altermagnets via Magnon-Phonon Coupling](https://arxiv.org/abs/2607.06792)
...
### [7] [Negative and Zero Linear Compressibility in MCN (M = Ag, Au, Cu): A First-Principles Study](https://arxiv.org/abs/2607.06904)
...
### [8] [AI2Pot: A scalable and unified framework for machine-learning interatomic potential development and large-scale molecular dynamic simulations](https://arxiv.org/abs/2607.06969)
...
### [9] [Surface-Reconstruction-Driven Insulating Behavior in Metallic Charge-Density-Wave 1T-TaSe$_{2}$](https://arxiv.org/abs/2607.06995)
...
### [10] [Size focusing in core-shell precipitates: A phase-field study](https://arxiv.org/abs/2607.07002)
...
### [11] [Minimizing propagated density errors of atomic core-electron for simultaneously accurate bandgaps and lattice constants in closed-shell Copper semiconductors](https://arxiv.org/abs/2607.07037)
...
### [12] [A modified Moss rule highlights underexplored classes of high refractive index materials](https://arxiv.org/abs/2607.07086)
...
### [13] [Phonon scattering mechanisms in WTe$_2$ observed by ultrafast coherent phonon spectroscopy](https://arxiv.org/abs/2607.07087)
...
### [14] [Unveiling Nanoscale Surface Damage Dynamics in Swift Heavy Ion Irradiated Gallium Nitride](https://arxiv.org/abs/2607.07092)
...
### [15] [Interplay of Umklapp scattering and Sb-Au hybridization in surface-reconstructed Sb/Au(111)](https://arxiv.org/abs/2607.07132)
...
### [16] [Understanding surface potential dynamics of passivated perovskites via Kelvin Probe Force Microscopy](https://arxiv.org/abs/2607.07221)
...
### [17] [Improving feature resolution and pore back effect in focused ion beam tomography of porous GaN thin films](https://arxiv.org/abs/2607.07273)
...
### [18] [Bayesian Optimization of Genetic Algorithm Hyperparameters in a Multi-Fidelity Framework for Efficient Lattice Material Design](https://arxiv.org/abs/2607.07289)
...
### [19] [A Topotactic Phase Transition in the Uranium Oxide System](https://arxiv.org/abs/2607.07291)
...
### [20] [Machine Learning Materials Properties by Encoding Orbital-Projected Density of States](https://arxiv.org/abs/2607.07339)
...
### [21] [Growth of (111)-textured SrTiO3 thin films on Pt(111)/Al2O3(1-102) substrates by rf magnetron sputter deposition](https://arxiv.org/abs/2607.07428)
...
### [22] [A Multi-Scale Machine Learning Framework for Coupled Chemical, Spin, and Structural Disorder in Alloys](https://arxiv.org/abs/2607.07456)
...
### [23] [Stress calculation in linear scaling DFT: convergence and dynamics](https://arxiv.org/abs/2607.07472)
...
### [24] [Non-Hermitian control of helicity-selective antiferromagnetic resonance](https://arxiv.org/abs/2607.07488)
...
### [25] [Human and LLM Collaboration for Accelerated Materials Synthesis and Discovery](https://arxiv.org/abs/2607.07604)
...
### [26] [MLIP Studio: An Open Platform for Interactive Benchmarking and Atomistic Simulations Using Machine Learning Interatomic Potentials](https://arxiv.org/abs/2607.07606)
...
### [27] [Decoding magnetic texture](https://arxiv.org/abs/2607.07685)
...
### [28] [Ab initio thermodynamic statistical modeling of the miscibility gap and the metal-insulator phase transition in SrTi$_{1-x}$V$_x$O$_{3}$](https://arxiv.org/abs/2607.07067)
...
### [29] [Floquet-Weyl states at one-photon resonances in three-dimensional topological insulators](https://arxiv.org/abs/2607.07199)
...
### [30] [Magnetocaloric properties of centered molecular quantum spin systems](https://arxiv.org/abs/2607.07307)
*H. Meel,J. Schnack*
...
### [31] [Pressure-induced PT Symmetry Breaking in LaMnSi](https://arxiv.org/abs/2607.07310)
...
### [32] [Magnetotransport Properties of Iron-Based Ladder Compounds BaFe2S3 and BaFe2Se3 under High Pressure](https://arxiv.org/abs/2607.07326)
...
### [33] [Ab Initio Investigation of Pressure Effects in the Spin-Liquid Candidate Y-Kapellasite](https://arxiv.org/abs/2607.07341)
...
### [34] [Crossover and Changeover in Spin-1 Kitaev-$Γ$ Chain with Uniaxial Single-ion Anisotropy](https://arxiv.org/abs/2607.07501)
...
### [35] [Wavelength-resolved small-angle neutron spectroscopy of spin waves in MnSi under pressure](https://arxiv.org/abs/2607.07660)
...
### [36] [Multistage development of short-range spin correlations and weak magnetic order in the two coupled trillium lattices of K2Fe2(MoO4)(PO4)2](https://arxiv.org/abs/2607.07681)
...
### [37] [Impact of Courant number on the results of numerical simulating of signal propagation in non-dispersive homogeneous media](https://arxiv.org/abs/2607.06707)
...
### [40] [Collaborate to decorrelate in path space: Hamiltonian replica exchange transition interface sampling (HRETIS)](https://arxiv.org/abs/2607.07453)
...
### [41] [Semilocal exchange functionals from the exact-exchange condition for the hydrogen atom: Hydrogenic exactness and recovery of Rydberg-like bound states](https://arxiv.org/abs/2607.07648)
*Fumihiro Imoto*
...
### [42] [Scaling WaterLily.jl with MPI and an improved geometric multigrid solver](https://arxiv.org/abs/2607.07687)
