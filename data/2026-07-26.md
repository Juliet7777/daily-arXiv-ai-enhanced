...
### [1] [Monte Carlo Studies of Twisted Bilayer Graphene: Strain and Thermal Fluctuations](https://arxiv.org/abs/2607.20619)
...
### [2] [Colloquium: Semi-Dirac Fermions in Quantum Matter](https://arxiv.org/abs/2607.20627)
...
### [3] [Ferromagnetic transition in a chiral spin chain](https://arxiv.org/abs/2607.20629)
...
### [4] [Doping-induced Ferromagnetic order and its unusual evolution to Helical Antiferromagnetic Order in Sr(Ni$_{1-x}$Co$_x$)$_2$P$_2$](https://arxiv.org/abs/2607.20663)
...
### [5] [Exact Nagaoka-to-spiral transition in the doped infinite-U triangular lattice](https://arxiv.org/abs/2607.20726)
...
### [6] [Gaplessness indicator by topologically trivial twisting operators](https://arxiv.org/abs/2607.20944)
...
### [14] [Lithium-Projected Phonon Spectral Distributions as Robust Descriptors of Ionic Conductivity in Solid Electrolytes](https://arxiv.org/abs/2607.20591)
...
### [15] [Magnetic ground states of CrPS$_4$ and NiPS$_3$ monolayers from long-range exchange interactions](https://arxiv.org/abs/2607.20631)
...
### [16] [A high-dimensional neural network potential for finite-temperature phenomena in NiTi martensite](https://arxiv.org/abs/2607.20681)
...
### [17] [Machine learning based prediction of optical properties in two-dimensional Mo-W-S-Se-Te transition-metal dichalcogenide alloys through physics-informed sampling](https://arxiv.org/abs/2607.21246)
...
### [18] [Analytical Forces from the Bethe-Salpeter Equation for Large-Scale Excited-State Relaxation](https://arxiv.org/abs/2607.20728)
...
### [19] [First-principles calculation of electron-phonon spectral functions for defects using phonon interpolation](https://arxiv.org/abs/2607.20788)
...
### [20] [Photo-induced currents and short-term memory for reservoir computing in a ferroelectric semiconductor](https://arxiv.org/abs/2607.20810)
...
### [21] [MatDiffract: A Material-Informed Automated Analysis Platform for X-ray Powder Diffraction](https://arxiv.org/abs/2607.20880)
...
### [22] [Long- and Short-Range Anion Order in SrTiO$_{3-x}$H$_x$ Perovskite Oxyhydrides: DFT+$U$ Sensitivity and HSE06 Cluster Expansion](https://arxiv.org/abs/2607.20885)
...
### [23] [Orbital Hall Effect Enables Field-Free Magnetization Reversal in Ferrimagnets without Additional Conversion Layer](https://arxiv.org/abs/2607.20888)
...
### [24] [Visualizing Microwave-Driven Dynamics of Antiskyrmions and Surface Skyrmions](https://arxiv.org/abs/2607.20904)
...
### [25] [Magneto-Caloric effect and Multiple magnetic phases in Al doped Ni2MnSn0.75Al0.25 Heusler Alloys](https://arxiv.org/abs/2607.21181)
...
### [26] [Uni-XAS: Alignment-Driven Bidirectional Multimodal Learning for X-ray Absorption Spectroscopy](https://arxiv.org/abs/2607.20906)
...
### [27] [Complete Raman Tensor Determination in Birefringent $β$-Ga$_2$O$_3$ by Single-Stage Hyperspectral Analysis of Polarization Angle-Resolved Raman Spectra](https://arxiv.org/abs/2607.21045)
...
### [29] [Lifetime effects and satellites in the photoelectron spectrum of platinum metal](https://arxiv.org/abs/2607.21298)
...
### [30] [A Single-Trace Surface Integral Equation Solver for Simulation of Open Bianisotropic Metasurfaces Described by Generalized Sheet Transition Conditions](https://arxiv.org/abs/2607.20659)
...
### [31] [Matrix-free phase-field modeling of fracture in micromechanical testing simulations of inelastic materials](https://arxiv.org/abs/2607.21150)
...
### [32] [Cycle-Consistent and Uncertainty-Aware Neural Surrogates for Tokamak Edge Plasmas](https://arxiv.org/abs/2607.21407)
