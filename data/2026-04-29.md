...
### [1] [Quantum Rotors on the Fuzzy Sphere and the Cubic CFT](https://arxiv.org/abs/2604.24840)
*Andreas Stergiou*
...
### [2] [Magnetic phases of the anisotropic triangular Hubbard model from the ghost-Gutzwiller approximation in the rotating spin-frame](https://arxiv.org/abs/2604.24848)
...
### [3] [Universal Topological Power Transfer with Arbitrarily Large Chern Number in Driven Quantum Spin Chains](https://arxiv.org/abs/2604.24851)
...
### [4] [Dynamical dimer structure factor of the triangular $S=1/2$ Heisenberg antiferromagnet](https://arxiv.org/abs/2604.24868)
...
### [5] [Anomaly and symmetry-charge flow in mixed states](https://arxiv.org/abs/2604.24872)
...
### [6] [Symmetry-Protected Topological Phases in the Triangular Majorana-Hubbard Ladder](https://arxiv.org/abs/2604.24887)
...
### [7] [Dielectric signatures of crystal-field and low-temperature correlated dynamics in NdMgAl11O19](https://arxiv.org/abs/2604.24937)
...
### [8] [Crystal-Field Symmetry Constraints in Layered Honeycomb ErBr$_3$](https://arxiv.org/abs/2604.24951)
...
### [9] [Tunable thermal conductivity through dual spin-phonon coupling in van der Waals ferromagnetic insulator Cr2Ge2Te6](https://arxiv.org/abs/2604.25115)
...
### [10] [Validity of DFT+U band gaps in all its known functional forms](https://arxiv.org/abs/2604.25706)
...
### [11] [Identifying strong correlation using only the Kohn-Sham density of one-electron states](https://arxiv.org/abs/2604.25125)
...
### [12] [Piezomagnetic effect of a rare-earth-based altermagnet TbPt6Al3](https://arxiv.org/abs/2604.25282)
...
### [13] [Flat band in multiband-metal MnSb$_2$](https://arxiv.org/abs/2604.25324)
...
### [14] [Intrinsic magnetotransport and orientation dependent topological Hall effect in EuAuBi](https://arxiv.org/abs/2604.25365)
...
### [15] [Raman Characterization of Two-Dimensional Quasiperiodic Antiferromagnets on Various Lattices: Spin-Orbit Mechanism](https://arxiv.org/abs/2604.25401)
...
### [16] [Highly fluctuating double-$q$ magnetic order in the van der Waals metal CeTe$_3$](https://arxiv.org/abs/2604.25436)
...
### [17] [Robust Metal-Insulator Transition Despite Surface Dead-Layer Growth in Sub-10-nm Cr-Doped V2O3 Nanocrystals](https://arxiv.org/abs/2604.25488)
...
### [18] [Non-magnetic floating phases in frustrated Haldane chains with a single-ion anisotropy](https://arxiv.org/abs/2604.25493)
...
### [19] [The odd-parity ALM induced reconstruction of the Chern-insulating phase in Haldane-Hubbard model](https://arxiv.org/abs/2604.25537)
...
### [20] [Topochemical Fluorination of La$_2$NiO$_{4+δ}$ Single Crystals](https://arxiv.org/abs/2604.25575)
...
### [21] [Self-consistent vertex corrected $GW$ with static and dynamic screening using tensor hypercontraction: assessment of molecular ionization potentials](https://arxiv.org/abs/2604.25581)
...
### [22] [Observation and Control of Moiré-Tailored Topological Dirac States](https://arxiv.org/abs/2604.25598)
...
### [23] [Collective and separate metal-insulator transitions in correlated vanadium dioxide](https://arxiv.org/abs/2604.25638)
...
### [24] [Exact results for the Hubbard model on bipartite lattices in spatial dimensions $d>1$: Seven theorems from the full [SU(2)$\times$SU(2)$\times$U(1)]/$\mathbb{Z}_2^2$ symmetry](https://arxiv.org/abs/2604.25712)
*J. M. P. Carmelo*
...
### [25] [Pareto Frontier of Neural Quantum States: Scalable, Affordable, and Accurate Convolutional Backflow for Strongly Correlated Lattice Fermions](https://arxiv.org/abs/2604.25775)
...
### [26] [Conditional Flow Matching for Probabilistic Downscaling of Maximum 3-day Snowfall in Alaska](https://arxiv.org/abs/2604.25172)
...
### [27] [Deterministic Realization of Classical Dissipation on Quantum Computers](https://arxiv.org/abs/2604.25429)
...
### [28] [Basic linear algebra methods for quantum problems](https://arxiv.org/abs/2604.25625)
...
### [29] [Trillion-atom molecular dynamics simulations with ab initio accuracy](https://arxiv.org/abs/2604.24816)
...
### [30] [Visualizing Crystallization Dynamics and Transformation Pathways of Disordered Rocksalt Oxides During Thermally Activated Sol-Gel Synthesis](https://arxiv.org/abs/2604.24941)
...
### [33] [Kohn-Sham Hamiltonian from Effective Field Theory: Quasiparticle Band Narrowing from Frozen Core Dynamics](https://arxiv.org/abs/2604.25199)
...
### [34] [Determination of the Fermi Energy of Diamond using Photoluminescence Spectral Analysis](https://arxiv.org/abs/2604.25097)
...
### [35] [Spin-Axis-Layer Locking for Intrinsic Bipolar Altermagnetic Semiconductors: Proof-of-Concept in Bilayer CuBr2](https://arxiv.org/abs/2604.25658)
...
### [36] [Electric-field control of hydrogen bonding via interfacial charge at atomic resolution](https://arxiv.org/abs/2604.25114)
...
### [37] [Predicting challenging phase transitions with Bayesian active learning](https://arxiv.org/abs/2604.25756)
...
### [38] [Benchmarking Universal Machine-Learned Interatomic Potentials for High-Temperature Metal-Organic Framework Chemistry](https://arxiv.org/abs/2604.25262)
...
### [39] [Reversible Modulation of Thermal Conductivity in GaN via Strain-Driven Reorganization of Dislocation Ensembles](https://arxiv.org/abs/2604.25287)
...
### [40] [Proximity Ferroelectricity Driven by Mobile High-Miller-Index Domain Walls](https://arxiv.org/abs/2604.25343)
...
### [41] [Determination of Burgers vectors of dislocations in monoclinic $β$-Ga$_2$O$_3$ crystals by large-angle convergent-beam electron diffraction](https://arxiv.org/abs/2604.25428)
...
### [42] [From Ultrafast Demagnetization to Ultrafast Spintronics : a 30 years story](https://arxiv.org/abs/2604.25431)
...
### [43] [Thermodynamic surface reconstruction governs catalytic behavior in high-entropy alloys](https://arxiv.org/abs/2604.25454)
...
### [44] [Probing sliding ferroelectricity in bilayer T$_\mathrm{d}$-WTe$_2$ with high-harmonic generation](https://arxiv.org/abs/2604.25483)
...
### [45] [Electronic structures of spin-orbit-coupled metal candidate PbRe$_2$O$_6$: one dimensionality and molecular orbital formation](https://arxiv.org/abs/2604.25539)
...
### [46] [Benchmarking bandgap prediction in semiconductors under experimental and realistic evaluation settings](https://arxiv.org/abs/2604.25568)
...
### [47] [Tuning magnitude and direction of lattice thermal conductivity in transition metal dichalcogenide heterobilayers](https://arxiv.org/abs/2604.25576)
...
### [48] [Substitutional platinum as an efficient nonradiative recombination center in silicon](https://arxiv.org/abs/2604.25621)
...
### [49] [Physical properties of transition metal hydride superconductors Mg2TmH6 (Tm = Rh, Pd, Ir, Pt) by first-principles calculations](https://arxiv.org/abs/2604.25626)
...
### [50] [Chemical transformation of MgH2/V2O5 composite to Mg-V-O rock salt and its influence on the electrochemical Li conversion and hydrogen storage characteristics of MgH2](https://arxiv.org/abs/2604.25718)
...
### [51] [Global DIC-based sample-detector geometry refinement for accurate EBSD indexing](https://arxiv.org/abs/2604.25869)
...
### [52] [Structure Prediction and Bonding Analysis of B$_{18}$Ag$_2$ Clusters Featuring Double-Ring Motifs](https://arxiv.org/abs/2604.25908)
