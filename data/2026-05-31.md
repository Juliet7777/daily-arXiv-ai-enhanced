...
### [14] [Geometry-based Discovery of Calcium Battery Cathodes Accelerated by Foundational Machine-Learned Models](https://arxiv.org/abs/2605.29029)
...
### [15] [Field-Driven Hybrid Filament Formation Governs Switching in Ta-HfO$_2$-Pt Memristors](https://arxiv.org/abs/2605.29127)
...
### [16] [Sustainable Metal-Organic Framework Water Harvesters in the Artificial Intelligence Era](https://arxiv.org/abs/2605.29179)
...
### [17] [Topological Lifshitz transition-induced bipolarity of anomalous Nernst effect in kagome magnet YCo3](https://arxiv.org/abs/2605.29297)
...
### [18] [Dynamic charges effect on infrared dielectric response of polar materials](https://arxiv.org/abs/2605.29437)
...
### [19] [Synthesizability, hardness, and stacking order in multicomponent transition metal carbides from machine-learned potentials](https://arxiv.org/abs/2605.29482)
...
### [20] [Alternative origins of polarity in compressively strained SrTiO3-RENiO3 capacitors](https://arxiv.org/abs/2605.29499)
...
### [21] [Finite-temperature micromagnetic model bridging atomic- and macro-scale magnetism](https://arxiv.org/abs/2605.29617)
*R. Kiefe,J. S. Amaral*
...
### [22] [Transition metal (group V) doping induced spin and valley polarization in MoS$_2$ monolayer](https://arxiv.org/abs/2605.29718)
...
### [23] [Spin-Orbit Coupling Effects on the Structural and Electronic Properties of Planar Pentagonal p-MS$_{2}$ (M = Si, Ge, and Pb)](https://arxiv.org/abs/2605.29730)
...
### [24] [Breaking Bipartite and Time Reversal Symmetries by Fusing Porphine Unit in-between two Zigzag-edge Graphene Nanoribbons](https://arxiv.org/abs/2605.29817)
...
### [25] [Accelerated Discovery of Nitrogen-Coordinated Dual-Atom Hydrogen Evolution Reaction Electrocatalysts via Machine Learning Potentials](https://arxiv.org/abs/2605.29821)
...
### [26] [Optical Cooling of Nuclear Spins in a CdTe/CdZnTe Quantum Well: The Impact of Kinetic Local Fields on Cooling Efficiency](https://arxiv.org/abs/2605.29855)
...
### [27] [Topological spin-texture transitions in van der Waals magnets revealed by X-ray Fourier transform holography](https://arxiv.org/abs/2605.29890)
...
### [28] [Carrier Localization in Pnictogen-Based Chalcohalides from Defect-Bound Hot Polarons](https://arxiv.org/abs/2605.29925)
...
### [29] [Prototype-Guided Latent Alignment for Data-Efficient Fine-Tuning of Molecular Foundation Models](https://arxiv.org/abs/2605.29969)
...
### [30] [Charting the thermodynamic stability of hybrid perovskite alloys with machine learning](https://arxiv.org/abs/2605.30012)
...
### [31] [Magnetic precession induced spin accumulation in collinear antiferromagnets](https://arxiv.org/abs/2605.30016)
*Q. Xue,J. Zhou*
...
### [32] [Hysteretic Acoustic Band Structures in Shape-Memory Composite Thin Rods](https://arxiv.org/abs/2605.30028)
...
### [33] [Towards exascale fully relativistic pseudopotential density functional theory calculations enabled by mixed-precision computation and compressed-communication using residual based subspace iteration](https://arxiv.org/abs/2605.30128)
...
### [34] [Composition-dependent Thin-film Synthesis of Layered Ternary Iron Nitrides FeMN2 (M = W, Mo)](https://arxiv.org/abs/2605.30137)
...
### [35] [What drives performance in molecular MPNNs? An operator-level factorial benchmark](https://arxiv.org/abs/2605.30195)
...
### [36] [Role of structure and charge trapping on the bipolaron formation and magnetic-field response of gated conjugated polymers](https://arxiv.org/abs/2605.30196)
...
### [37] [Exploring the Origins of Anti-Ambipolarity in BBL Polymer: Links to Redox Chemistry, Electronic Structure, and Structural Dynamics](https://arxiv.org/abs/2605.30270)
