...
### [6] [The "Moiré Capacitor Effect" and Stabilization of Fractional Chern Insulators in Rhombohedral Graphene Superlattices](https://arxiv.org/abs/2608.12452)
...
### [7] [Boundary phases and thermodynamics of the Kondo spin-$s$ chain: from overscreened Kondo to boundary-bound states](https://arxiv.org/abs/2608.12453)
...
### [8] [Fermionic Anomalies of Finite Symmetries on Lattices](https://arxiv.org/abs/2608.12455)
...
### [9] [Revisiting magnon bound states: ferro-antiferromagnetic $J_1\!-\!J_2$ square-lattice model](https://arxiv.org/abs/2608.12459)
...
### [10] [Superconductivity in the $t$-$t'$ Hubbard Model from Symmetry-Preserving Neural-Network Quantum States](https://arxiv.org/abs/2608.12465)
...
### [12] [Defect-induced optical magnons and local magnetic correlations in MnSb2Te4](https://arxiv.org/abs/2608.12505)
...
### [13] [Dipolar-driven mean-field criticality in the ferrimagnet Eu$_2$MnSi$_2$O$_7$](https://arxiv.org/abs/2608.12639)
...
### [14] [Correlation versus Causation in Quantum Criticality](https://arxiv.org/abs/2608.12770)
...
### [15] [Topology and Quantum-Spin-Classical-Spin Crossover of the Gapped Kondo Effect](https://arxiv.org/abs/2608.13065)
...
### [16] [Magnetism in antiperovskite (Li$_2$\textit{M})\textit{Ch}O (\textit{M} = Fe, Mn, Co; \textit{Ch} = S, Se) diluted magnets with fixed 1/3 filling: the key role of magnetic anisotropy](https://arxiv.org/abs/2608.13111)
...
### [17] [Emergent Symmetry-Protected Topological Phases via Polyakov Confinement in Quantum Spin Systems](https://arxiv.org/abs/2608.13238)
...
### [18] [Imaginary-time correlations in time-sliced stochastic series expansion](https://arxiv.org/abs/2608.13477)
...
### [24] [Giant exciton effects and magneto-excitonic coupling in V4S9X4 2D magnetic semiconductors](https://arxiv.org/abs/2608.13093)
...
### [26] [Thermal transport in crystals: from the quantum Dyson equation to mesoscopic phonon hydrodynamics](https://arxiv.org/abs/2608.13339)
...
### [27] [Magnetic reconstruction of the altermagnet α-MnTe(0001) surface driven by ligand holes](https://arxiv.org/abs/2608.12878)
