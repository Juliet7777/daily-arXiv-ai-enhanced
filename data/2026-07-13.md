...
### [2] [Interface-induced spin-resolved type-II band alignment and enhanced magnetic anisotropy in MSe2/WTe2 (M = V, Cr, Mn, Fe and Co) van der Waals heterobilayers](https://arxiv.org/abs/2607.08926)
...
### [3] [Grain-boundary-mediated kinetic arrest in graphite-to-diamond transformation](https://arxiv.org/abs/2607.08868)
...
### [4] [High density two-component glasses of organic semiconductors prepared by physical vapor deposition](https://arxiv.org/abs/2607.08881)
...
### [5] [Hybrid DiffractGPT-Rietveld Refinement Framework for Automated X-ray Diffraction Analysis](https://arxiv.org/abs/2607.08890)
...
### [13] [Energetics of fractional anomalous Hall crystals in rhombohedral graphene](https://arxiv.org/abs/2607.08822)
...
### [14] [The monopole plasma resonance: a smoking gun of 3D $U(1)$ quantum spin liquids](https://arxiv.org/abs/2607.08826)
...
### [15] [Magnetic Field Control of the Néel Vector and Magnon Visibility in Altermagnetic MnTe](https://arxiv.org/abs/2607.08829)
...
### [16] [Loop-current orderings in SU($N$) two-leg fermionic ladder through duality symmetries](https://arxiv.org/abs/2607.08862)
...
### [17] [Magnetic devil's staircase in UAgBi$_{2}$](https://arxiv.org/abs/2607.09003)
...
### [18] [Topological phase transition driven by Hatsugai-Kohmoto interaction on the Kagome lattice](https://arxiv.org/abs/2607.09182)
...
### [19] [Sixteenfold Classification of Many-Body Multipoles from Rotation-Compatible Canonical Symmetries](https://arxiv.org/abs/2607.09395)
...
### [20] [Short-range magnetic order and multi-stage phase transitions in the easy-plane van der Waals magnet CrCl$_3$](https://arxiv.org/abs/2607.09421)
...
### [21] [Effective theories for many-body systems with nonuniform symmetries](https://arxiv.org/abs/2607.09427)
...
### [22] [Strongly correlated quantum matter: t--J model, real-space pairing, spin-dependent masses, and atomicity in chemical bond and nanosystems](https://arxiv.org/abs/2607.09465)
*Józef Spałek*
...
### [23] [Symmetry-Protected Pinch Curves in Classical Spin Liquids](https://arxiv.org/abs/2607.09470)
...
### [24] [Quantum Chaos with a Macroscopic Zero-Mode Sector](https://arxiv.org/abs/2607.09504)
...
### [25] [A nonstandard statistics for strongly correlated systems: Two simple examples](https://arxiv.org/abs/2607.09542)
...
### [26] [Thermalization in a Height-Conserving Quantum Dimer Model](https://arxiv.org/abs/2607.09580)
...
### [27] [Scale-Bridging Phase-Field Modeling of Microstructure Evolution by FE$^2$ Computational Homogenization](https://arxiv.org/abs/2607.09356)
