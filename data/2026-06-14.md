...
### [3] [Mixed-dimensional quantum Monte Carlo studies of M-point moiré materials](https://arxiv.org/abs/2606.12508)
...
### [4] [Spin correlations, low-energy scales, and anisotropy scaling in kagome frustrated magnets](https://arxiv.org/abs/2606.12512)
...
### [5] [Cyclotron mass-selective de Haas-van Alphen measurements using temperature modulation](https://arxiv.org/abs/2606.12514)
...
### [6] [Hidden antiferromagnetism, persistent valley fluctuations, and $U(6)$ crossovers in triangular-lattice M-point moiré materials via determinantal quantum Monte Carlo](https://arxiv.org/abs/2606.12530)
...
### [7] [Hall conductivity reveals the nature of quantum coherence in strongly correlated metals](https://arxiv.org/abs/2606.12665)
...
### [8] [Selective stabilization of antiferromagnetic orders in FeTe films via local strain engineering](https://arxiv.org/abs/2606.13257)
...
### [9] [Phase diagram of the Kitaev-Heisenberg-$Γ$ model: Classical and quantum magnetism, frustration, and subdominant interactions](https://arxiv.org/abs/2606.13263)
...
### [10] [Frustration effects on the magnetization plateau physics in a trimerized quantum spin-1/2 chain](https://arxiv.org/abs/2606.13265)
...
### [11] [Modeling strained Cd$_3$As$_2$ thin films and their behavior in magnetic fields](https://arxiv.org/abs/2606.13293)
...
### [12] [Variational Monte Carlo study of a two-orbital Hubbard model for the iron pnictides](https://arxiv.org/abs/2606.13342)
...
### [13] [Overview of the Theory of Extremely Correlated Fermi Liquids](https://arxiv.org/abs/2606.13541)
*B Sriram Shastry*
...
### [14] [Molecular reference corrections for quantum Monte Carlo adsorption energies](https://arxiv.org/abs/2606.12779)
...
### [15] [Hierarchical Interdiffusion Kinetics in Nanoscale Ni/Al Multilayers](https://arxiv.org/abs/2606.12553)
...
### [16] [Compositional gradient engineering for enhanced ferroelectricity in ultrathin AlScN](https://arxiv.org/abs/2606.12568)
...
### [17] [Computationally efficient method for determining limiting velocities of edge dislocations in anisotropic crystals](https://arxiv.org/abs/2606.12591)
*Daniel N. Blaschke*
...
### [18] [Resolving Finite-Size Errors in EOM-CCSD Band Gaps of Solids with Interacting-Bath Dynamical Embedding Theory](https://arxiv.org/abs/2606.12621)
...
### [19] [Lock-In Infrared Thermography: Phase Analysis for Rapid, Wide-Range Thermal Conductivity Measurements](https://arxiv.org/abs/2606.12625)
...
### [20] [Site Preferences and "Coloring Problem" in Cu-doped BiMn$_7$O$_{12}$ Quadruple Perovskite](https://arxiv.org/abs/2606.12711)
...
### [21] [Extending the La Solubility Limit in Sr$_3$Ir$_2$O$_7$ through High-Pressure High-Temperature Synthesis](https://arxiv.org/abs/2606.12727)
...
### [22] [Water Flow Through Polar and Non-Polar Nanopores: Insights from Multiscale Simulations](https://arxiv.org/abs/2606.12743)
...
### [23] [Intrinsic Ductility from Shear Amorphization: From Pure Metals to Multi-Principal-Element Alloys](https://arxiv.org/abs/2606.12750)
...
### [24] [A wrong ground-state structure of HfO$_2$ predicted by machine-learning interatomic potentials based on the PBE functional](https://arxiv.org/abs/2606.12811)
...
### [25] [Leveraging rapid sintering to retain metastable zirconia in copper](https://arxiv.org/abs/2606.12860)
...
### [26] [Conditional spinodal decomposition in Li-Mg anodes for lithium metal batteries](https://arxiv.org/abs/2606.12932)
...
### [27] [Observation of orbital-angular-momentum-driven temperature modulation via the spin Peltier effect](https://arxiv.org/abs/2606.12992)
...
### [28] [A Geometric Design Principle for $\mathbb{Z}_2$ Topological Phases in Twisted Triangular-Lattice Bilayers](https://arxiv.org/abs/2606.13015)
...
### [29] [Holonomy Analysis of Optical-polarization Temperature Trajectories in Stress-induced Ferroelectric SrTiO$_3$](https://arxiv.org/abs/2606.13074)
...
### [30] [Disentangling the origin of degradation in perovskite solar cells via optical imaging and Bayesian inference](https://arxiv.org/abs/2606.13114)
...
### [31] [A first-principles approach for predicting infrared optical properties of solids](https://arxiv.org/abs/2606.13143)
...
### [32] [Decoding Crystallographic Surface Chirality with Machine Learning: From Atomic Geometry to Fermi Surface Projections](https://arxiv.org/abs/2606.13144)
...
### [35] [Enhanced Photocurrent Response in Epitaxial 0.5PZT-0.5PFN Multiferroic Thin Films](https://arxiv.org/abs/2606.13399)
...
### [36] [Physics-informed time-series forecasting of perovskite photoluminescence stability](https://arxiv.org/abs/2606.13414)
...
### [37] [The phase composition and physical properties of melt-quenched multicomponent alloy FeCoNiB0.7Si0.3Be](https://arxiv.org/abs/2606.13420)
...
### [38] [Dopant-induced modifications of the optical properties of GaSe](https://arxiv.org/abs/2606.13424)
...
### [39] [Symmetry-electronic fingerprints reveal competing magnetic phases in two-dimensional materials](https://arxiv.org/abs/2606.13548)
...
### [40] [Lone-Pair-Induced Lattice Softness Enables Ultralow Thermal Conductivity in Hybrid Organic-Inorganic Perovskite GuaPbI$_3$](https://arxiv.org/abs/2606.13561)
...
### [41] [Tuning perpendicular magnetic anisotropy in ultra-low damping Li$_{0.5}$Al$_{x}$Fe$_{(2.5-x)}$O$_4$ thin films for efficient spin-orbit torque switching](https://arxiv.org/abs/2606.13573)
...
### [42] [Cepstral Analysis to accelerate Green-Kubo thermal conductivity calculations of Metal-Organic Frameworks](https://arxiv.org/abs/2606.13588)
...
### [43] [Morphology control and low-temperature magnetotransport in chiral 2D perovskite R-(MBA)$_2$PbI$_4$](https://arxiv.org/abs/2606.13664)
