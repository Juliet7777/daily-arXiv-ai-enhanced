...
### [3] [Field-tuned incommensurate fan phase in an Ising-like triangular antiferromagnet](https://arxiv.org/abs/2607.23173)
...
### [4] [Hyperdeterminant wavefunctions](https://arxiv.org/abs/2607.23392)
...
### [5] [Interplay of Spin Waves, Crystal-Field Excitations, and Phonons in Multiferroic Ba3HoRu2O9 revealed by Inelastic Neutron Scattering, Crystal-Field Analysis, and Machine-Learned Phonon Calculations](https://arxiv.org/abs/2607.23490)
...
### [6] [Observation of an emergent energy scale close to dimensional reduction in a quasi-two-dimensional quantum magnet](https://arxiv.org/abs/2607.23547)
...
### [8] [Engineering two-body interaction for the Moore-Read State](https://arxiv.org/abs/2607.23695)
...
### [9] [Symmetry Criterion for Van Hove Criticality at Non-Time-Reversal-Invariant Momenta](https://arxiv.org/abs/2607.23985)
...
### [10] [Magnetic-texture winding controls fermion-parity switches in an interacting $p$-wave magnet wire](https://arxiv.org/abs/2607.24038)
*Hyun-Yong Lee*
...
### [11] [Accessing Few-Layer CrI$_3$ Magnetoelasticity Through Bulk Single Crystals](https://arxiv.org/abs/2607.24222)
...
### [12] [Distinct finite-temperature phase diagrams of non-invertible Kennedy--Tasaki duals](https://arxiv.org/abs/2607.24231)
...
### [13] [Magnetic anisotropy in the near-stoichiometric van der Waals ferromagnet Fe$_3$GeTe$_2$](https://arxiv.org/abs/2607.24543)
...
### [14] [Self-energy pole optimization of superconductivity in the bilayer Hubbard model](https://arxiv.org/abs/2607.24549)
...
### [17] [Curl-based Electric-Field Boundary Condition for the Accurate and Stable Electromagnetic Scattering Analysis](https://arxiv.org/abs/2607.23260)
...
### [18] [PI-GINOT: Data-free geometry-informed neural operator learning for finite-strain hyperelasticity on parametric DogBone specimens](https://arxiv.org/abs/2607.23299)
...
### [19] [Self-consistent orbital-free nuclear density functional theory with a physics-constrained learned nonlocal kinetic energy functional](https://arxiv.org/abs/2607.23328)
*Fumihiro Imoto*
...
### [20] [Tunable mesoscopic numerical model for bacterial biofilms](https://arxiv.org/abs/2607.23677)
...
### [21] [Stochastic Counterdiabatic Driving via Biorthogonal Liouvillian Eigenmodes](https://arxiv.org/abs/2607.24393)
...
### [22] [Reframing the coupling force of adaptive resolution simulation in terms of the Liouville-type hierarchy for open systems](https://arxiv.org/abs/2607.24574)
...
### [23] [AEcroscopyWave: Towards Self-Driving Characterization Platforms for Agentic AI](https://arxiv.org/abs/2607.22975)
...
### [25] [Uncertainty-quantified $J$-integral computation for quasicontinuum and finite element methods](https://arxiv.org/abs/2607.23003)
...
### [26] [Molecular dynamics with a first-principles-validated universal machine-learning potential reveals dynamic elementary processes of growth-related adspecies on GaN(0001)](https://arxiv.org/abs/2607.23461)
...
### [27] [Ferroelastic exciton splitting in hybrid perovskite nanowalls](https://arxiv.org/abs/2607.23051)
...
### [28] [Hydrogen-Induced Sign Reversal in Magnetic Hysteresis Evolution of CoPd Alloys and Co/Pd Multilayers](https://arxiv.org/abs/2607.23053)
*S. S. Das,A. Gerber*
...
### [29] [Imaging of van der Waals Materials via Standing-Wave Photoemission Microscopy: Depth-Resolved Electronic Structure of WS2](https://arxiv.org/abs/2607.23073)
...
### [30] [A DFT and Machine Learning-Assisted Study on the Lattice Thermal Conductivity of LiCdSb for Thermoelectric Applications](https://arxiv.org/abs/2607.23203)
...
### [31] [Stoichiometric cluster learning for few-shot property prediction of multi-ionic integrated energetic materials](https://arxiv.org/abs/2607.23208)
...
### [32] [Fermi-level mediated acceleration of flash sintering of oxide ceramics](https://arxiv.org/abs/2607.23383)
...
### [33] [Tailoring the Frequency-Dependent Optical Response of Hematite through Mono- and Co-Doping: A First-Principles Study](https://arxiv.org/abs/2607.23409)
...
### [34] [Fe-doping-induced band structure modification and cryogenic phase stability in Cs2AgBiBr6 single crystals](https://arxiv.org/abs/2607.23456)
...
### [35] [Universal temperature-dependent electrical resistivity in actinides](https://arxiv.org/abs/2607.23484)
*E. F. Talantsev*
...
### [36] [Observation of correlation-driven topological transport and robust ferromagnetism in 2D CrS$_2$](https://arxiv.org/abs/2607.23625)
...
### [37] [Elemental Germanium Phase-Change Memory](https://arxiv.org/abs/2607.23709)
...
### [38] [Harnessing X-ray Absorption Spectroscopy Data through Multimodal Mining of Battery Literature](https://arxiv.org/abs/2607.23886)
...
### [39] [Nature of Cr Segregation in FCC to BCC quenched Fe-12Cr Alloy, with Post-Quenching Heat Treatment: A Positron Annihilation Study](https://arxiv.org/abs/2607.23995)
...
### [40] [Recrystallisation phenomena in an ultrafine-grained Al-Mg-Si alloy revealed by correlative in situ EBSD and TEM heating](https://arxiv.org/abs/2607.24085)
...
### [41] [Interaction-driven electronic ferroelectricity in van der Waals heterostructures](https://arxiv.org/abs/2607.24087)
...
### [42] [Atomic-scale phase-field modeling with dopants: Stochastic self-consistent harmonic approximation with fractional site occupancy](https://arxiv.org/abs/2607.24107)
...
### [43] [Square Net TaSiAs Nanowires with Topological Surface Conduction and Linear Magnetoresistance](https://arxiv.org/abs/2607.24244)
...
### [44] [Catalyst Diffusion Transformer: Generative Inverse Design of Heterogeneous Catalysts](https://arxiv.org/abs/2607.24272)
...
### [45] [Aligning Heterogeneous DFT Datasets: A Graph Neural Network Approach to Cross-Functional Formation Energies](https://arxiv.org/abs/2607.24327)
...
### [46] [Hybrid-parity sliding multiferroics](https://arxiv.org/abs/2607.24337)
...
### [47] [Neural RHEED alignment with limited training data during CdTe MBE growth](https://arxiv.org/abs/2607.24467)
...
### [48] [Quantum oscillation fingerprints of altermagnetism in hole-doped RuO2](https://arxiv.org/abs/2607.24599)
...
### [49] [A General Model of Interfacial Chemical Equilibrium in Phase-Field Method](https://arxiv.org/abs/2607.24620)
...
### [50] [Growth and characterization of planar hexagonal Ge on CdS](https://arxiv.org/abs/2607.24685)
